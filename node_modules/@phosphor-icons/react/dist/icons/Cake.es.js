...
var l = (t, e, c) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, m = (t, e) => {
  for (var c in e || (e = {}))
    Z.call(e, c) && l(t, c, e[c]);
  if (V)
    for (var c of V(e))
...
]), C = o((t, e) => /* @__PURE__ */ a.createElement(p, A(m({ ref: e }, t), { weights: v })));
C.displayName = "Cake";
export {
  C as default
};
