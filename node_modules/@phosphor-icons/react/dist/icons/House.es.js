...
var V = (t, e, l) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, r = (t, e) => {
  for (var l in e || (e = {}))
    E.call(e, l) && V(t, l, e[l]);
  if (n)
    for (var l of n(e))
      p.call(e, l) && V(t, l, e[l]);
  return t;
}, H = (t, e) => h(t, o(e));
...
]), m = M((t, e) => /* @__PURE__ */ a.createElement(d, H(r({ ref: e }, t), { weights: u })));
m.displayName = "House";
const s = m;
export {
  s as default
