...
var L = (l, e, t) => e in l ? H(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, m = (l, e) => {
  for (var t in e || (e = {}))
    M.call(e, t) && L(l, t, e[t]);
  if (n)
    for (var t of n(e))
...
]), c = o((l, e) => /* @__PURE__ */ a.createElement(A, r(m({ ref: e }, l), { weights: E })));
c.displayName = "Backspace";
const u = c;
export {
  u as default
};
