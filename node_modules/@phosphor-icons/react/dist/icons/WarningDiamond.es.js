...
var n = (l, e, t) => e in l ? h(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, r = (l, e) => {
  for (var t in e || (e = {}))
    d.call(e, t) && n(l, t, e[t]);
  if (m)
    for (var t of m(e))
      i.call(e, t) && n(l, t, e[t]);
  return l;
}, Z = (l, e) => o(l, A(e));
...
]), c = E((l, e) => /* @__PURE__ */ a.createElement(p, Z(r({ ref: e }, l), { weights: g })));
c.displayName = "WarningDiamond";
const f = c;
export {
  f as default
};
