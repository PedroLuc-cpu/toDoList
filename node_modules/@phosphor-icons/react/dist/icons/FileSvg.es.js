...
var A = (c, e, l) => e in c ? Z(c, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : c[e] = l, m = (c, e) => {
  for (var l in e || (e = {}))
    M.call(e, l) && A(c, l, e[l]);
  if (t)
    for (var l of t(e))
      V.call(e, l) && A(c, l, e[l]);
  return c;
}, n = (c, e) => r(c, h(e));
...
]), p = v((c, e) => /* @__PURE__ */ a.createElement(s, n(m({ ref: e }, c), { weights: o })));
p.displayName = "FileSvg";
export {
  p as default
};
