...
var c = (A, e, t) => e in A ? l(A, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : A[e] = t, Z = (A, e) => {
  for (var t in e || (e = {}))
    p.call(e, t) && c(A, t, e[t]);
  if (m)
    for (var t of m(e))
      o.call(e, t) && c(A, t, e[t]);
  return A;
}, n = (A, e) => r(A, M(e));
...
]), g = E((A, e) => /* @__PURE__ */ a.createElement(i, n(Z({ ref: e }, A), { weights: d })));
g.displayName = "Fingerprint";
export {
  g as default
};
