...
var n = (H, e, t) => e in H ? V(H, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : H[e] = t, r = (H, e) => {
  for (var t in e || (e = {}))
    v.call(e, t) && n(H, t, e[t]);
  if (l)
    for (var t of l(e))
      Z.call(e, t) && n(H, t, e[t]);
  return H;
}, h = (H, e) => c(H, M(e));
...
const o = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement("path", { d: "M240,112H229.2L201.42,49.5A16,16,0,0,0,186.8,40H69.2a16,16,0,0,0-14.62,9.5L26.8,112H16a8,8,0,0,0,0,16h8v80a16,16,0,0,0,16,16H64a16,16,0,0,0,16-16V192h96v16a16,16,0,0,0,16,16h24a16,16,0,0,0,16-16V128h8a8,8,0,0,0,0-16Z" }))
  ],
  [
    "light",
...
]), m = p((H, e) => /* @__PURE__ */ a.createElement(L, h(r({ ref: e }, H), { weights: o })));
m.displayName = "CarSimple";
const g = m;
export {
  g as default
};
