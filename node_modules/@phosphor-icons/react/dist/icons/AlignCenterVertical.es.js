...
var V = (t, e, h) => e in t ? m(t, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : t[e] = h, l = (t, e) => {
  for (var h in e || (e = {}))
    Z.call(e, h) && V(t, h, e[h]);
  if (H)
    for (var h of H(e))
      i.call(e, h) && V(t, h, e[h]);
  return t;
}, n = (t, e) => v(t, c(e));
...
]), r = o((t, e) => /* @__PURE__ */ a.createElement(E, n(l({ ref: e }, t), { weights: M })));
r.displayName = "AlignCenterVertical";
const A = r;
export {
  A as default
};
