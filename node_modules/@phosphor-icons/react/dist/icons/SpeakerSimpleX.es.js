...
var L = (l, e, t) => e in l ? A(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, n = (l, e) => {
  for (var t in e || (e = {}))
    p.call(e, t) && L(l, t, e[t]);
  if (m)
    for (var t of m(e))
      Z.call(e, t) && L(l, t, e[t]);
  return l;
}, r = (l, e) => H(l, c(e));
...
]), d = E((l, e) => /* @__PURE__ */ a.createElement(o, r(n({ ref: e }, l), { weights: M })));
d.displayName = "SpeakerSimpleX";
export {
  d as default
};
