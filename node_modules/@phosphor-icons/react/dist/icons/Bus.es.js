...
var t = (Z, e, m) => e in Z ? n(Z, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : Z[e] = m, V = (Z, e) => {
  for (var m in e || (e = {}))
    M.call(e, m) && t(Z, m, e[m]);
  if (H)
    for (var m of H(e))
      h.call(e, m) && t(Z, m, e[m]);
  return Z;
}, v = (Z, e) => A(Z, r(e));
...
]), l = c((Z, e) => /* @__PURE__ */ a.createElement(o, v(V({ ref: e }, Z), { weights: E })));
l.displayName = "Bus";
const s = l;
export {
  s as default
