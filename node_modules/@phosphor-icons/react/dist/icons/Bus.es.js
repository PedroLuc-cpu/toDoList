...
var t = (Z, e, m) => e in Z ? l(Z, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : Z[e] = m, V = (Z, e) => {
  for (var m in e || (e = {}))
    r.call(e, m) && t(Z, m, e[m]);
  if (H)
    for (var m of H(e))
...
]), p = h((Z, e) => /* @__PURE__ */ a.createElement(c, v(V({ ref: e }, Z), { weights: o })));
p.displayName = "Bus";
export {
  p as default
};
