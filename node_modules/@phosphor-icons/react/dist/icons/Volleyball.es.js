...
var Z = (t, e, l) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, m = (t, e) => {
  for (var l in e || (e = {}))
    o.call(e, l) && Z(t, l, e[l]);
  if (A)
    for (var l of A(e))
      E.call(e, l) && Z(t, l, e[l]);
  return t;
}, n = (t, e) => c(t, h(e));
...
]), M = p((t, e) => /* @__PURE__ */ a.createElement(L, n(m({ ref: e }, t), { weights: d })));
M.displayName = "Volleyball";
const i = M;
export {
  i as default
};
