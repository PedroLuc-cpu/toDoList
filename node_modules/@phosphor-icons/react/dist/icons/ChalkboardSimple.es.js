...
var V = (t, e, m) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, h = (t, e) => {
  for (var m in e || (e = {}))
    Z.call(e, m) && V(t, m, e[m]);
  if (l)
    for (var m of l(e))
      o.call(e, m) && V(t, m, e[m]);
  return t;
}, n = (t, e) => H(t, c(e));
...
]), i = p((t, e) => /* @__PURE__ */ a.createElement(d, n(h({ ref: e }, t), { weights: E })));
