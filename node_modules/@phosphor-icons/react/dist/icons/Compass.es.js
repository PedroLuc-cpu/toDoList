...
var n = (l, a, t) => a in l ? A(l, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[a] = t, r = (l, a) => {
  for (var t in a || (a = {}))
    M.call(a, t) && n(l, t, a[t]);
  if (m)
    for (var t of m(a))
...
const h = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement("path", { d: "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm51.58,57.79-32,64a4.08,4.08,0,0,1-1.79,1.79l-64,32a4,4,0,0,1-5.37-5.37l32-64a4.08,4.08,0,0,1,1.79-1.79l64-32A4,4,0,0,1,179.58,81.79Z" }))
  ],
  [
    "light",
...
]), c = s((l, a) => /* @__PURE__ */ e.createElement(d, Z(r({ ref: a }, l), { weights: h })));
