...
var Z = (t, a, m) => a in t ? H(t, a, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[a] = m, V = (t, a) => {
  for (var m in a || (a = {}))
    v.call(a, m) && Z(t, m, a[m]);
  if (h)
    for (var m of h(a))
...
]), d = c((t, a) => /* @__PURE__ */ e.createElement(E, l(V({ ref: a }, t), { weights: p })));
d.displayName = "Wall";
export {
  d as default
};
