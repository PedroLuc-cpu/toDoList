...
var m = (t, e, n) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, l = (t, e) => {
  for (var n in e || (e = {}))
    c.call(e, n) && m(t, n, e[n]);
  if (V)
    for (var n of V(e))
      o.call(e, n) && m(t, n, e[n]);
  return t;
}, Z = (t, e) => H(t, M(e));
...
]), r = v((t, e) => /* @__PURE__ */ a.createElement(d, Z(l({ ref: e }, t), { weights: i })));
r.displayName = "LinkedinLogo";
const h = r;
export {
  h as default
};
