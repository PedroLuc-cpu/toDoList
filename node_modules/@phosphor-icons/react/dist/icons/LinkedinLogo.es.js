...
var n = (t, e, V) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, l = (t, e) => {
  for (var V in e || (e = {}))
    M.call(e, V) && n(t, V, e[V]);
  if (m)
    for (var V of m(e))
      c.call(e, V) && n(t, V, e[V]);
  return t;
}, r = (t, e) => A(t, H(e));
...
]), p = o((t, e) => /* @__PURE__ */ a.createElement(v, r(l({ ref: e }, t), { weights: d })));
