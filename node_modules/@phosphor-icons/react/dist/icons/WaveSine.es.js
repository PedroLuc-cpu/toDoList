...
var l = (a, t, c) => t in a ? C(a, t, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[t] = c, r = (a, t) => {
  for (var c in t || (t = {}))
    E.call(t, c) && l(a, c, t[c]);
  if (n)
    for (var c of n(t))
      d.call(t, c) && l(a, c, t[c]);
  return a;
}, m = (a, t) => o(a, p(t));
...
]), u = i((a, t) => /* @__PURE__ */ e.createElement(h, m(r({ ref: t }, a), { weights: g })));
u.displayName = "WaveSine";
export {
  u as default
};
