...
var t = (m, e, Z) => e in m ? r(m, e, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : m[e] = Z, l = (m, e) => {
  for (var Z in e || (e = {}))
    h.call(e, Z) && t(m, Z, e[Z]);
  if (A)
    for (var Z of A(e))
...
]), i = p((m, e) => /* @__PURE__ */ a.createElement(E, n(l({ ref: e }, m), { weights: d })));
