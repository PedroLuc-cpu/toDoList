...
var m = (t, e, H) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, V = (t, e) => {
  for (var H in e || (e = {}))
    v.call(e, H) && m(t, H, e[H]);
  if (l)
    for (var H of l(e))
...
]), n = o((t, e) => /* @__PURE__ */ a.createElement(M, h(V({ ref: e }, t), { weights: d })));
n.displayName = "FolderLock";
const g = n;
export {
  g as default
};
