...
var m = (t, e, c) => e in t ? C(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, n = (t, e) => {
  for (var c in e || (e = {}))
    p.call(e, c) && m(t, c, e[c]);
  if (l)
    for (var c of l(e))
      A.call(e, c) && m(t, c, e[c]);
  return t;
}, r = (t, e) => E(t, o(e));
...
]), g = Z((t, e) => /* @__PURE__ */ a.createElement(d, r(n({ ref: e }, t), { weights: h })));
g.displayName = "Ear";
export {
  g as default
};
