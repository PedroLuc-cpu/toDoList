...
var L = (l, e, V) => e in l ? r(l, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : l[e] = V, A = (l, e) => {
  for (var V in e || (e = {}))
    p.call(e, V) && L(l, V, e[V]);
  if (t)
    for (var V of t(e))
      o.call(e, V) && L(l, V, e[V]);
  return l;
}, n = (l, e) => m(l, c(e));
...
]), v = E((l, e) => /* @__PURE__ */ a.createElement(M, n(A({ ref: e }, l), { weights: d })));
v.displayName = "Airplane";
const g = v;
export {
  g as default
};
