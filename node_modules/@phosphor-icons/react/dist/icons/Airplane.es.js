...
var L = (l, e, V) => e in l ? v(l, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : l[e] = V, A = (l, e) => {
  for (var V in e || (e = {}))
    c.call(e, V) && L(l, V, e[V]);
  if (t)
    for (var V of t(e))
...
]), d = o((l, e) => /* @__PURE__ */ a.createElement(E, n(A({ ref: e }, l), { weights: M })));
d.displayName = "Airplane";
export {
  d as default
};
