...
var r = (t, a, m) => a in t ? h(t, a, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[a] = m, n = (t, a) => {
  for (var m in a || (a = {}))
    d.call(a, m) && r(t, m, a[m]);
  if (l)
    for (var m of l(a))
...
]), H = p((t, a) => /* @__PURE__ */ e.createElement(E, Z(n({ ref: a }, t), { weights: M })));
