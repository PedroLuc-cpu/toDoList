...
var m = (e, l, L) => l in e ? Z(e, l, { enumerable: !0, configurable: !0, writable: !0, value: L }) : e[l] = L, n = (e, l) => {
  for (var L in l || (l = {}))
    o.call(l, L) && m(e, L, l[L]);
  if (t)
    for (var L of t(l))
...
]), u = E((e, l) => /* @__PURE__ */ a.createElement(d, r(n({ ref: l }, e), { weights: g })));
u.displayName = "Plugs";
export {
  u as default
};
