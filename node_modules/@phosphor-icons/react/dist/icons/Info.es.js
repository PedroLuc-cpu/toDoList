...
var l = (t, a, m) => a in t ? c(t, a, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[a] = m, r = (t, a) => {
  for (var m in a || (a = {}))
    p.call(a, m) && l(t, m, a[m]);
  if (n)
    for (var m of n(a))
      d.call(a, m) && l(t, m, a[m]);
  return t;
}, Z = (t, a) => o(t, E(a));
...
]), A = M((t, a) => /* @__PURE__ */ e.createElement(h, Z(r({ ref: a }, t), { weights: f })));
A.displayName = "Info";
const s = A;
export {
  s as default
