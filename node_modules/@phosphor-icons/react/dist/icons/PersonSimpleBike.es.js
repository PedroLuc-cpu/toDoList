...
var A = (m, e, t) => e in m ? c(m, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : m[e] = t, Z = (m, e) => {
  for (var t in e || (e = {}))
    p.call(e, t) && A(m, t, e[t]);
  if (l)
    for (var t of l(e))
      M.call(e, t) && A(m, t, e[t]);
  return m;
}, n = (m, e) => L(m, o(e));
...
]), r = i((m, e) => /* @__PURE__ */ a.createElement(E, n(Z({ ref: e }, m), { weights: d })));
r.displayName = "PersonSimpleBike";
const g = r;
export {
  g as default
};
