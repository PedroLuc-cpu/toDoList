...
var r = (t, a, A) => a in t ? m(t, a, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[a] = A, H = (t, a) => {
  for (var A in a || (a = {}))
    M.call(a, A) && r(t, A, a[A]);
  if (l)
    for (var A of l(a))
      c.call(a, A) && r(t, A, a[A]);
  return t;
}, n = (t, a) => V(t, Z(a));
...
]), p = h((t, a) => /* @__PURE__ */ e.createElement(o, n(H({ ref: a }, t), { weights: d })));
p.displayName = "FolderUser";
export {
  p as default
};
