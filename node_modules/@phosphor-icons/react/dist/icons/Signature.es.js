...
var l = (c, e, t) => e in c ? C(c, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : c[e] = t, r = (c, e) => {
  for (var t in e || (e = {}))
    Z.call(e, t) && l(c, t, e[t]);
  if (n)
    for (var t of n(e))
      o.call(e, t) && l(c, t, e[t]);
  return c;
}, m = (c, e) => H(c, h(e));
...
]), d = p((c, e) => /* @__PURE__ */ a.createElement(E, m(r({ ref: e }, c), { weights: M })));
d.displayName = "Signature";
export {
  d as default
};
