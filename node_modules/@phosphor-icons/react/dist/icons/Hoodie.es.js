...
var m = (e, l, V) => l in e ? h(e, l, { enumerable: !0, configurable: !0, writable: !0, value: V }) : e[l] = V, n = (e, l) => {
  for (var V in l || (l = {}))
    M.call(l, V) && m(e, V, l[V]);
  if (t)
    for (var V of t(l))
      A.call(l, V) && m(e, V, l[V]);
  return e;
}, Z = (e, l) => r(e, H(l));
...
]), d = c((e, l) => /* @__PURE__ */ a.createElement(L, Z(n({ ref: l }, e), { weights: o })));
d.displayName = "Hoodie";
export {
  d as default
};
