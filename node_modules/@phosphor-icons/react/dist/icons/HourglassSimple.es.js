...
var r = (l, a, t) => a in l ? H(l, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[a] = t, m = (l, a) => {
  for (var t in a || (a = {}))
    M.call(a, t) && r(l, t, a[t]);
  if (n)
    for (var t of n(a))
      L.call(a, t) && r(l, t, a[t]);
  return l;
}, A = (l, a) => Z(l, c(a));
...
]), d = o((l, a) => /* @__PURE__ */ e.createElement(p, A(m({ ref: a }, l), { weights: E })));
d.displayName = "HourglassSimple";
export {
  d as default
};
