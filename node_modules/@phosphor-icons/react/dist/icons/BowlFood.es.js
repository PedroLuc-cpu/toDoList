...
var H = (t, e, A) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, m = (t, e) => {
  for (var A in e || (e = {}))
    M.call(e, A) && H(t, A, e[A]);
  if (l)
    for (var A of l(e))
      h.call(e, A) && H(t, A, e[A]);
  return t;
}, n = (t, e) => o(t, c(e));
...
]), Z = d((t, e) => /* @__PURE__ */ a.createElement(E, n(m({ ref: e }, t), { weights: p })));
Z.displayName = "BowlFood";
const u = Z;
export {
  u as default
};
