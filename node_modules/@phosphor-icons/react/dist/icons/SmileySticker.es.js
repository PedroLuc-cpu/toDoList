...
var c = (t, e, m) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, n = (t, e) => {
  for (var m in e || (e = {}))
    M.call(e, m) && c(t, m, e[m]);
  if (l)
    for (var m of l(e))
...
]), d = p((t, e) => /* @__PURE__ */ a.createElement(E, r(n({ ref: e }, t), { weights: i })));
d.displayName = "SmileySticker";
export {
  d as default
};
