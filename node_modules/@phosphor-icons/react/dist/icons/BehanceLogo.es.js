...
var Z = (t, e, H) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, n = (t, e) => {
  for (var H in e || (e = {}))
    h.call(e, H) && Z(t, H, e[H]);
  if (m)
    for (var H of m(e))
      o.call(e, H) && Z(t, H, e[H]);
  return t;
}, l = (t, e) => c(t, M(e));
...
]), r = E((t, e) => /* @__PURE__ */ a.createElement(p, l(n({ ref: e }, t), { weights: d })));
r.displayName = "BehanceLogo";
const i = r;
export {
  i as default
};
