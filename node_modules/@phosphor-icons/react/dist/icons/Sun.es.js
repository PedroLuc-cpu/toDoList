...
var t = (l, e, m) => e in l ? M(l, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : l[e] = m, n = (l, e) => {
  for (var m in e || (e = {}))
    V.call(e, m) && t(l, m, e[m]);
  if (Z)
    for (var m of Z(e))
      h.call(e, m) && t(l, m, e[m]);
  return l;
}, A = (l, e) => c(l, H(e));
...
]), r = o((l, e) => /* @__PURE__ */ a.createElement(E, A(n({ ref: e }, l), { weights: p })));
r.displayName = "Sun";
const i = r;
export {
  i as default
