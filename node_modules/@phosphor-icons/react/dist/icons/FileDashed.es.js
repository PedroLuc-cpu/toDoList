...
var H = (t, e, V) => e in t ? m(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, Z = (t, e) => {
  for (var V in e || (e = {}))
    A.call(e, V) && H(t, V, e[V]);
  if (h)
    for (var V of h(e))
      r.call(e, V) && H(t, V, e[V]);
  return t;
}, l = (t, e) => n(t, M(e));
...
]), o = v((t, e) => /* @__PURE__ */ a.createElement(c, l(Z({ ref: e }, t), { weights: d })));
o.displayName = "FileDashed";
export {
  o as default
};
