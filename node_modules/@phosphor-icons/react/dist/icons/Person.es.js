...
var m = (l, e, L) => e in l ? c(l, e, { enumerable: !0, configurable: !0, writable: !0, value: L }) : l[e] = L, n = (l, e) => {
  for (var L in e || (e = {}))
    o.call(e, L) && m(l, L, e[L]);
  if (t)
    for (var L of t(e))
      h.call(e, L) && m(l, L, e[L]);
  return l;
}, r = (l, e) => A(l, Z(e));
...
]), M = p((l, e) => /* @__PURE__ */ a.createElement(E, r(n({ ref: e }, l), { weights: d })));
