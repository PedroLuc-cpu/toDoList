...
var Z = (t, e, m) => e in t ? M(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, l = (t, e) => {
  for (var m in e || (e = {}))
    d.call(e, m) && Z(t, m, e[m]);
  if (A)
    for (var m of A(e))
...
]), r = p((t, e) => /* @__PURE__ */ a.createElement(h, n(l({ ref: e }, t), { weights: s })));
r.displayName = "Broadcast";
const f = r;
export {
  f as default
};
