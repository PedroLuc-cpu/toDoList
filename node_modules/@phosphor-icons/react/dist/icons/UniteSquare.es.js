...
var l = (t, a, H) => a in t ? Z(t, a, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[a] = H, n = (t, a) => {
  for (var H in a || (a = {}))
    c.call(a, H) && l(t, H, a[H]);
  if (m)
    for (var H of m(a))
...
]), E = L((t, a) => /* @__PURE__ */ e.createElement(o, r(n({ ref: a }, t), { weights: p })));
E.displayName = "UniteSquare";
export {
  E as default
};
