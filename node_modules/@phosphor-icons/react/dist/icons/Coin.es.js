...
var m = (t, c, a) => c in t ? l(t, c, { enumerable: !0, configurable: !0, writable: !0, value: a }) : t[c] = a, Z = (t, c) => {
  for (var a in c || (c = {}))
    v.call(c, a) && m(t, a, c[a]);
  if (C)
    for (var a of C(c))
      s.call(c, a) && m(t, a, c[a]);
  return t;
}, n = (t, c) => r(t, V(c));
