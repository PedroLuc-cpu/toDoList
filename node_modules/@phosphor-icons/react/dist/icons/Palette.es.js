...
var Z = (t, e, A) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, l = (t, e) => {
  for (var A in e || (e = {}))
    M.call(e, A) && Z(t, A, e[A]);
  if (m)
    for (var A of m(e))
      o.call(e, A) && Z(t, A, e[A]);
  return t;
}, n = (t, e) => c(t, h(e));
...
]), g = p((t, e) => /* @__PURE__ */ a.createElement(E, n(l({ ref: e }, t), { weights: d })));
g.displayName = "Palette";
export {
  g as default
};
