...
var H = (t, e, c) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, l = (t, e) => {
  for (var c in e || (e = {}))
    o.call(e, c) && H(t, c, e[c]);
  if (m)
    for (var c of m(e))
      s.call(e, c) && H(t, c, e[c]);
  return t;
}, n = (t, e) => h(t, C(e));
...
]), r = p((t, e) => /* @__PURE__ */ a.createElement(E, n(l({ ref: e }, t), { weights: S })));
r.displayName = "ToiletPaper";
const i = r;
export {
  i as default
};
