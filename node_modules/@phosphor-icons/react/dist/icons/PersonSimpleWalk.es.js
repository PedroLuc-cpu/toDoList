...
var c = (l, e, t) => e in l ? Z(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, n = (l, e) => {
  for (var t in e || (e = {}))
    E.call(e, t) && c(l, t, e[t]);
  if (m)
    for (var t of m(e))
      d.call(e, t) && c(l, t, e[t]);
  return l;
}, r = (l, e) => o(l, p(e));
...
]), A = i((l, e) => /* @__PURE__ */ a.createElement(h, r(n({ ref: e }, l), { weights: s })));
A.displayName = "PersonSimpleWalk";
const M = A;
export {
  M as default
};
