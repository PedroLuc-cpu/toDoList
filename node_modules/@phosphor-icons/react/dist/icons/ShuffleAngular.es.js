...
var L = (e, l, t) => l in e ? r(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, m = (e, l) => {
  for (var t in l || (l = {}))
    Z.call(l, t) && L(e, t, l[t]);
  if (H)
    for (var t of H(l))
      c.call(l, t) && L(e, t, l[t]);
  return e;
}, n = (e, l) => h(e, A(l));
...
]), u = o((e, l) => /* @__PURE__ */ a.createElement(p, n(m({ ref: l }, e), { weights: E })));
u.displayName = "ShuffleAngular";
export {
  u as default
};
