...
var m = (e, H, Z) => H in e ? r(e, H, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : e[H] = Z, h = (e, H) => {
  for (var Z in H || (H = {}))
    d.call(H, Z) && m(e, Z, H[Z]);
  if (t)
    for (var Z of t(H))
      o.call(H, Z) && m(e, Z, H[Z]);
  return e;
}, n = (e, H) => M(e, c(H));
...
]), l = A((e, H) => /* @__PURE__ */ a.createElement(E, n(h({ ref: H }, e), { weights: p })));
l.displayName = "Gradient";
const s = l;
export {
  s as default
};
