...
var t = (e, H, Z) => H in e ? l(e, H, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : e[H] = Z, h = (e, H) => {
  for (var Z in H || (H = {}))
    c.call(H, Z) && t(e, Z, H[Z]);
  if (m)
    for (var Z of m(H))
      d.call(H, Z) && t(e, Z, H[Z]);
  return e;
}, n = (e, H) => r(e, M(H));
...
]), E = o((e, H) => /* @__PURE__ */ a.createElement(p, n(h({ ref: H }, e), { weights: A })));
E.displayName = "Gradient";
export {
  E as default
};
