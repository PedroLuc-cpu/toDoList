...
var l = (t, e, A) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, h = (t, e) => {
  for (var A in e || (e = {}))
    Z.call(e, A) && l(t, A, e[A]);
  if (c)
    for (var A of c(e))
...
]), d = p((t, e) => /* @__PURE__ */ a.createElement(E, m(h({ ref: e }, t), { weights: M })));
d.displayName = "AppleLogo";
export {
  d as default
};
