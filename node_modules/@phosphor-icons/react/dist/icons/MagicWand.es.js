...
var V = (t, e, h) => e in t ? H(t, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : t[e] = h, Z = (t, e) => {
  for (var h in e || (e = {}))
    v.call(e, h) && V(t, h, e[h]);
  if (l)
    for (var h of l(e))
...
]), o = L((t, e) => /* @__PURE__ */ a.createElement(c, n(Z({ ref: e }, t), { weights: d })));
o.displayName = "MagicWand";
export {
  o as default
};
