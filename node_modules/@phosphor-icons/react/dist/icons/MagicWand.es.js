...
var V = (t, e, h) => e in t ? M(t, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : t[e] = h, n = (t, e) => {
  for (var h in e || (e = {}))
    r.call(e, h) && V(t, h, e[h]);
  if (l)
    for (var h of l(e))
      L.call(e, h) && V(t, h, e[h]);
  return t;
}, Z = (t, e) => v(t, m(e));
...
]), H = c((t, e) => /* @__PURE__ */ a.createElement(d, Z(n({ ref: e }, t), { weights: o })));
H.displayName = "MagicWand";
const g = H;
export {
  g as default
};
