...
var h = (t, e, V) => e in t ? v(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, m = (t, e) => {
  for (var V in e || (e = {}))
    c.call(e, V) && h(t, V, e[V]);
  if (H)
    for (var V of H(e))
      Z.call(e, V) && h(t, V, e[V]);
  return t;
}, l = (t, e) => r(t, A(e));
...
]), n = o((t, e) => /* @__PURE__ */ a.createElement(E, l(m({ ref: e }, t), { weights: p })));
n.displayName = "Bathtub";
const i = n;
export {
  i as default
};
