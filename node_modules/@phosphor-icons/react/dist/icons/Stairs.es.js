...
var m = (t, a, H) => a in t ? r(t, a, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[a] = H, l = (t, a) => {
  for (var H in a || (a = {}))
    h.call(a, H) && m(t, H, a[H]);
  if (V)
    for (var H of V(a))
...
]), p = M((t, a) => /* @__PURE__ */ e.createElement(A, n(l({ ref: a }, t), { weights: o })));
p.displayName = "Stairs";
export {
  p as default
};
