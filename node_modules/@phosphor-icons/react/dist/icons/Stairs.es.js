...
var m = (t, a, H) => a in t ? v(t, a, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[a] = H, l = (t, a) => {
  for (var H in a || (a = {}))
    c.call(a, H) && m(t, H, a[H]);
  if (V)
    for (var H of V(a))
...
]), r = A((t, a) => /* @__PURE__ */ e.createElement(o, n(l({ ref: a }, t), { weights: E })));
