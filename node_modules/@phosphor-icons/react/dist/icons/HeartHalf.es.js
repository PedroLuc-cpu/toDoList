...
var n = (t, a, c) => a in t ? Z(t, a, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[a] = c, r = (t, a) => {
  for (var c in a || (a = {}))
    o.call(a, c) && n(t, c, a[c]);
  if (l)
    for (var c of l(a))
...
const d = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement("path", { d: "M170.21,52.72a12,12,0,0,0-4.42-23.59C150.5,32,137.49,39.2,128.08,49.66,116,36,98.14,28,78,28A66.08,66.08,0,0,0,12,94c0,31,18.91,63,56.2,94.87a342.69,342.69,0,0,0,54.11,37.7A12.1,12.1,0,0,0,128,228a11.92,11.92,0,0,0,5.68-1.46v0A339.75,339.75,0,0,0,175.32,199a12,12,0,0,0-14.64-19c-7.48,5.76-14.63,10.72-20.68,14.68V74.55C145.43,63.23,156.31,55.32,170.21,52.72ZM116,194.66a318.88,318.88,0,0,1-32.51-24.3C61.82,151.77,36,123.42,36,94A42,42,0,0,1,78,52c17,0,31.35,8.57,38,22.52ZM233,99.93a12,12,0,0,1-13.25-10.61,41.89,41.89,0,0,0-18.41-30.25,12,12,0,0,1,13.34-20A65.84,65.84,0,0,1,243.6,86.68,12,12,0,0,1,233,99.93Zm1,33.42c-5.84,11.72-14.33,23.63-25.23,35.43a12,12,0,0,1-17.62-16.29c9.36-10.13,16.55-20.17,21.38-29.84A12,12,0,1,1,234,133.35Z" }))
  ],
  [
    "duotone",
