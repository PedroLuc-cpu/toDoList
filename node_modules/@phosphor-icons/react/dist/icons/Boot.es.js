...
var h = (e, H, l) => H in e ? m(e, H, { enumerable: !0, configurable: !0, writable: !0, value: l }) : e[H] = l, n = (e, H) => {
  for (var l in H || (H = {}))
    o.call(H, l) && h(e, l, H[l]);
  if (t)
    for (var l of t(H))
      Z.call(H, l) && h(e, l, H[l]);
  return e;
}, r = (e, H) => V(e, L(H));
...
]), c = M((e, H) => /* @__PURE__ */ a.createElement(A, r(n({ ref: H }, e), { weights: E })));
c.displayName = "Boot";
const g = c;
export {
  g as default
