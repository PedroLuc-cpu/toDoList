...
var C = (e, s, a) => s in e ? l(e, s, { enumerable: !0, configurable: !0, writable: !0, value: a }) : e[s] = a, m = (e, s) => {
  for (var a in s || (s = {}))
    Z.call(s, a) && C(e, a, s[a]);
  if (t)
    for (var a of t(s))
      v.call(s, a) && C(e, a, s[a]);
  return e;
}, S = (e, s) => n(e, r(s));
import c, { forwardRef as o } from "react";
...
]), M = o((e, s) => /* @__PURE__ */ c.createElement(p, S(m({ ref: s }, e), { weights: E })));
M.displayName = "SealQuestion";
export {
  M as default
};
