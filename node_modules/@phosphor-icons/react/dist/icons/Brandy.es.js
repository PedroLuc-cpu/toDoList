...
var l = (t, e, n) => e in t ? m(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, r = (t, e) => {
  for (var n in e || (e = {}))
    Z.call(e, n) && l(t, n, e[n]);
  if (H)
    for (var n of H(e))
      d.call(e, n) && l(t, n, e[n]);
  return t;
}, A = (t, e) => c(t, M(e));
...
]), h = o((t, e) => /* @__PURE__ */ a.createElement(E, A(r({ ref: e }, t), { weights: p })));
h.displayName = "Brandy";
const i = h;
export {
  i as default
};
