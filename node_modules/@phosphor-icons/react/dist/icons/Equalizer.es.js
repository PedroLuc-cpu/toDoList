...
var t = (m, H, e) => H in m ? n(m, H, { enumerable: !0, configurable: !0, writable: !0, value: e }) : m[H] = e, h = (m, H) => {
  for (var e in H || (H = {}))
    E.call(H, e) && t(m, e, H[e]);
  if (Z)
    for (var e of Z(H))
      M.call(H, e) && t(m, e, H[e]);
  return m;
}, l = (m, H) => r(m, c(H));
...
]), A = o((m, H) => /* @__PURE__ */ a.createElement(p, l(h({ ref: H }, m), { weights: d })));
A.displayName = "Equalizer";
export {
  A as default
};
