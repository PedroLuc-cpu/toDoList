...
var t = (e, H, m) => H in e ? r(e, H, { enumerable: !0, configurable: !0, writable: !0, value: m }) : e[H] = m, h = (e, H) => {
  for (var m in H || (H = {}))
    M.call(H, m) && t(e, m, H[m]);
  if (Z)
    for (var m of Z(H))
      o.call(H, m) && t(e, m, H[m]);
  return e;
}, l = (e, H) => c(e, E(H));
...
]), n = p((e, H) => /* @__PURE__ */ a.createElement(d, l(h({ ref: H }, e), { weights: u })));
n.displayName = "Equalizer";
const g = n;
export {
  g as default
};
