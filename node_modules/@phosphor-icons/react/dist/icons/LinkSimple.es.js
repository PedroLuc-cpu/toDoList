...
var m = (e, l, t) => l in e ? L(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, r = (e, l) => {
  for (var t in l || (l = {}))
    i.call(l, t) && m(e, t, l[t]);
  if (n)
    for (var t of n(l))
...
]), Z = E((e, l) => /* @__PURE__ */ a.createElement(d, c(r({ ref: l }, e), { weights: h })));
Z.displayName = "LinkSimple";
const s = Z;
export {
  s as default
};
