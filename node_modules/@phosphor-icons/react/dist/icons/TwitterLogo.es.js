...
var A = (c, e, t) => e in c ? m(c, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : c[e] = t, n = (c, e) => {
  for (var t in e || (e = {}))
    h.call(e, t) && A(c, t, e[t]);
  if (l)
    for (var t of l(e))
      p.call(e, t) && A(c, t, e[t]);
  return c;
}, r = (c, e) => C(c, o(e));
...
]), g = E((c, e) => /* @__PURE__ */ a.createElement(d, r(n({ ref: e }, c), { weights: Z })));
g.displayName = "TwitterLogo";
export {
  g as default
};
