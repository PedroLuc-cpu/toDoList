...
var n = (A, e, t) => e in A ? Z(A, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : A[e] = t, l = (A, e) => {
  for (var t in e || (e = {}))
    p.call(e, t) && n(A, t, e[t]);
  if (m)
    for (var t of m(e))
      i.call(e, t) && n(A, t, e[t]);
  return A;
}, r = (A, e) => c(A, M(e));
...
]), g = o((A, e) => /* @__PURE__ */ a.createElement(E, r(l({ ref: e }, A), { weights: d })));
g.displayName = "FingerprintSimple";
export {
  g as default
};
