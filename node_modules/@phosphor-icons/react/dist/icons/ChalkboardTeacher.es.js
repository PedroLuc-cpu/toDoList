...
var r = (t, e, H) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, n = (t, e) => {
  for (var H in e || (e = {}))
    h.call(e, H) && r(t, H, e[H]);
  if (l)
    for (var H of l(e))
...
]), V = o((t, e) => /* @__PURE__ */ a.createElement(d, m(n({ ref: e }, t), { weights: E })));
V.displayName = "ChalkboardTeacher";
const v = V;
export {
  v as default
};
