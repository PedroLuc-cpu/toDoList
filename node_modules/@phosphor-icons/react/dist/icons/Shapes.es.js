...
var Z = (t, e, l) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, n = (t, e) => {
  for (var l in e || (e = {}))
    p.call(e, l) && Z(t, l, e[l]);
  if (m)
    for (var l of m(e))
      o.call(e, l) && Z(t, l, e[l]);
  return t;
}, h = (t, e) => M(t, c(e));
...
const d = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement("path", { d: "M111.59,181.47A8,8,0,0,1,104,192H24a8,8,0,0,1-7.59-10.53l40-120a8,8,0,0,1,15.18,0ZM208,76a52,52,0,1,0-52,52A52.06,52.06,0,0,0,208,76Zm16,68H136a8,8,0,0,0-8,8v56a8,8,0,0,0,8,8h88a8,8,0,0,0,8-8V152A8,8,0,0,0,224,144Z" }))
  ],
  [
    "light",
...
]), r = E((t, e) => /* @__PURE__ */ a.createElement(H, h(n({ ref: e }, t), { weights: d })));
r.displayName = "Shapes";
const u = r;
export {
  u as default
};
