...
var r = (t, e, m) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, n = (t, e) => {
  for (var m in e || (e = {}))
    u.call(e, m) && r(t, m, e[m]);
  if (l)
    for (var m of l(e))
...
const d = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a.createElement("path", { d: "M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32Zm0,176H48V48H208V208Zm-80-96c-.61,0-1.22,0-1.82,0L142.87,84.1a8,8,0,0,0-13.74-8.2l-32.23,54A36,36,0,1,0,128,112Zm0,56a20,20,0,1,1,20-20A20,20,0,0,1,128,168Z" }))
  ],
  [
    "fill",
...
]), H = E((t, e) => /* @__PURE__ */ a.createElement(p, A(n({ ref: e }, t), { weights: d })));
H.displayName = "NumberSquareSix";
const g = H;
export {
  g as default
};
