...
var H = (V, e, l) => e in V ? Z(V, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : V[e] = l, n = (V, e) => {
  for (var l in e || (e = {}))
    M.call(e, l) && H(V, l, e[l]);
  if (t)
    for (var l of t(e))
      c.call(e, l) && H(V, l, e[l]);
  return V;
}, r = (V, e) => L(V, h(e));
...
]), m = A((V, e) => /* @__PURE__ */ a.createElement(d, r(n({ ref: e }, V), { weights: o })));
