...
var H = (V, e, t) => e in V ? m(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, n = (V, e) => {
  for (var t in e || (e = {}))
    h.call(e, t) && H(V, t, e[t]);
  if (l)
    for (var t of l(e))
...
]), o = c((V, e) => /* @__PURE__ */ a.createElement(A, r(n({ ref: e }, V), { weights: d })));
o.displayName = "CalendarX";
export {
  o as default
};
