...
var A = (l, a, t) => a in l ? V(l, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[a] = t, m = (l, a) => {
  for (var t in a || (a = {}))
    E.call(a, t) && A(l, t, a[t]);
  if (n)
    for (var t of n(a))
      Z.call(a, t) && A(l, t, a[t]);
  return l;
}, r = (l, a) => L(l, o(a));
...
const h = /* @__PURE__ */ new Map([
  ...
  [
    "thin",
    /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement("path", { d: "M227,51.15A11.85,11.85,0,0,0,216,44H40a12,12,0,0,0-8.88,20.07l.05.05,67.73,72.31a4,4,0,0,1,1.08,2.74V216a12,12,0,0,0,18.66,10l32-21.33a12,12,0,0,0,5.35-10V139.17a4,4,0,0,1,1.08-2.74l67.78-72.36A11.85,11.85,0,0,0,227,51.15Zm-8,7.5L151.24,131a12,12,0,0,0-3.24,8.21v55.49a4,4,0,0,1-1.78,3.33l-32,21.33A4,4,0,0,1,108,216V139.17a12,12,0,0,0-3.24-8.21L37.05,58.67A4,4,0,0,1,40,52H216a4,4,0,0,1,3,6.65Z" }))
  ]
]), c = p((l, a) => /* @__PURE__ */ e.createElement(d, r(m({ ref: a }, l), { weights: h })));
c.displayName = "Funnel";
const g = c;
export {
  g as default
};
