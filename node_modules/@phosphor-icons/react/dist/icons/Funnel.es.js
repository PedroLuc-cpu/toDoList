...
var A = (l, a, t) => a in l ? c(l, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[a] = t, m = (l, a) => {
  for (var t in a || (a = {}))
    o.call(a, t) && A(l, t, a[t]);
  if (n)
    for (var t of n(a))
      p.call(a, t) && A(l, t, a[t]);
  return l;
}, r = (l, a) => V(l, L(a));
...
]), h = E((l, a) => /* @__PURE__ */ e.createElement(Z, r(m({ ref: a }, l), { weights: d })));
h.displayName = "Funnel";
export {
  h as default
};
