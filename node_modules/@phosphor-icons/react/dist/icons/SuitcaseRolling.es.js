...
var H = (V, e, t) => e in V ? r(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, l = (V, e) => {
  for (var t in e || (e = {}))
    v.call(e, t) && H(V, t, e[t]);
  if (m)
    for (var t of m(e))
...
]), Z = o((V, e) => /* @__PURE__ */ a.createElement(M, n(l({ ref: e }, V), { weights: i })));
Z.displayName = "SuitcaseRolling";
const g = Z;
export {
  g as default
};
