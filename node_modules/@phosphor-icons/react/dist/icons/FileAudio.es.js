...
var H = (t, e, A) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, V = (t, e) => {
  for (var A in e || (e = {}))
    M.call(e, A) && H(t, A, e[A]);
  if (l)
    for (var A of l(e))
      c.call(e, A) && H(t, A, e[A]);
  return t;
}, m = (t, e) => h(t, r(e));
...
]), n = o((t, e) => /* @__PURE__ */ a.createElement(d, m(V({ ref: e }, t), { weights: L })));
n.displayName = "FileAudio";
const v = n;
export {
  v as default
};
