...
var c = (t, e, l) => e in t ? V(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, r = (t, e) => {
  for (var l in e || (e = {}))
    H.call(e, l) && c(t, l, e[l]);
  if (n)
    for (var l of n(e))
      A.call(e, l) && c(t, l, e[l]);
  return t;
}, h = (t, e) => M(t, Z(e));
...
]), m = o((t, e) => /* @__PURE__ */ a.createElement(E, h(r({ ref: e }, t), { weights: p })));
m.displayName = "Flask";
const g = m;
export {
  g as default
