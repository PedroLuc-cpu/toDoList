...
var n = (t, a, c) => a in t ? E(t, a, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[a] = c, r = (t, a) => {
  for (var c in a || (a = {}))
    C.call(a, c) && n(t, c, a[c]);
  if (l)
    for (var c of l(a))
      d.call(a, c) && n(t, c, a[c]);
  return t;
}, m = (t, a) => h(t, p(a));
...
]), o = i((t, a) => /* @__PURE__ */ e.createElement(g, m(r({ ref: a }, t), { weights: u })));
o.displayName = "CircleNotch";
const f = o;
export {
  f as default
};
