...
var r = (t, e, m) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, n = (t, e) => {
  for (var m in e || (e = {}))
    o.call(e, m) && r(t, m, e[m]);
  if (l)
    for (var m of l(e))
      h.call(e, m) && r(t, m, e[m]);
  return t;
}, H = (t, e) => A(t, Z(e));
...
const p = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement("path", { d: "M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM152,168a8,8,0,0,1,0,16H104a8,8,0,0,1-6.4-12.8l43.17-57.56a16,16,0,1,0-27.86-15,8,8,0,0,1-15.09-5.34,32,32,0,1,1,55.74,29.93L120,168Z" }))
  ],
  [
    "light",
...
]), V = u((t, e) => /* @__PURE__ */ a.createElement(E, H(n({ ref: e }, t), { weights: p })));
V.displayName = "NumberSquareTwo";
const i = V;
export {
  i as default
};
