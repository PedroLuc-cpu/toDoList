...
var m = (c, e, t) => e in c ? l(c, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : c[e] = t, C = (c, e) => {
  for (var t in e || (e = {}))
    M.call(e, t) && m(c, t, e[t]);
  if (A)
    for (var t of A(e))
      h.call(e, t) && m(c, t, e[t]);
  return c;
}, Z = (c, e) => n(c, r(e));
...
]), E = o((c, e) => /* @__PURE__ */ a.createElement(s, Z(C({ ref: e }, c), { weights: p })));
E.displayName = "Atom";
export {
  E as default
};
