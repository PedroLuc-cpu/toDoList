...
var l = (V, e, t) => e in V ? n(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, Z = (V, e) => {
  for (var t in e || (e = {}))
    v.call(e, t) && l(V, t, e[t]);
  if (m)
    for (var t of m(e))
      c.call(e, t) && l(V, t, e[t]);
  return V;
}, H = (V, e) => r(V, M(e));
...
]), p = A((V, e) => /* @__PURE__ */ a.createElement(d, H(Z({ ref: e }, V), { weights: o })));
p.displayName = "Buildings";
export {
  p as default
};
