...
var l = (V, e, t) => e in V ? r(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, Z = (V, e) => {
  for (var t in e || (e = {}))
    v.call(e, t) && l(V, t, e[t]);
  if (m)
    for (var t of m(e))
      d.call(e, t) && l(V, t, e[t]);
  return V;
}, n = (V, e) => M(V, c(e));
...
]), H = A((V, e) => /* @__PURE__ */ a.createElement(i, n(Z({ ref: e }, V), { weights: o })));
H.displayName = "Buildings";
const u = H;
export {
  u as default
};
