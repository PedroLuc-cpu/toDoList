...
var r = (t, e, c) => e in t ? o(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, n = (t, e) => {
  for (var c in e || (e = {}))
    H.call(e, c) && r(t, c, e[c]);
  if (l)
    for (var c of l(e))
      h.call(e, c) && r(t, c, e[c]);
  return t;
...
]), C = Z((t, e) => /* @__PURE__ */ a.createElement(M, m(n({ ref: e }, t), { weights: E })));
C.displayName = "ArrowsClockwise";
const i = C;
export {
  i as default
};
