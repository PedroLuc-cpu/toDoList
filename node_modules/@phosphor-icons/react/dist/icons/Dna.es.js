...
var A = (t, e, V) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, n = (t, e) => {
  for (var V in e || (e = {}))
    c.call(e, V) && A(t, V, e[V]);
  if (l)
    for (var V of l(e))
...
]), E = M((t, e) => /* @__PURE__ */ a.createElement(o, h(n({ ref: e }, t), { weights: p })));
E.displayName = "Dna";
export {
  E as default
};
