...
var A = (t, e, V) => e in t ? H(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, n = (t, e) => {
  for (var V in e || (e = {}))
    Z.call(e, V) && A(t, V, e[V]);
  if (l)
    for (var V of l(e))
      M.call(e, V) && A(t, V, e[V]);
  return t;
}, h = (t, e) => m(t, c(e));
...
]), r = o((t, e) => /* @__PURE__ */ a.createElement(E, h(n({ ref: e }, t), { weights: p })));
r.displayName = "Dna";
const i = r;
export {
  i as default
