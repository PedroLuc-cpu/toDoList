...
var H = (t, e, V) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, Z = (t, e) => {
  for (var V in e || (e = {}))
    c.call(e, V) && H(t, V, e[V]);
  if (m)
    for (var V of m(e))
      d.call(e, V) && H(t, V, e[V]);
  return t;
}, l = (t, e) => v(t, h(e));
...
]), n = A((t, e) => /* @__PURE__ */ a.createElement(o, l(Z({ ref: e }, t), { weights: E })));
n.displayName = "Faders";
const g = n;
export {
  g as default
};
