...
var A = (l, e, c) => e in l ? n(l, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : l[e] = c, Z = (l, e) => {
  for (var c in e || (e = {}))
    h.call(e, c) && A(l, c, e[c]);
  if (t)
    for (var c of t(e))
      V.call(e, c) && A(l, c, e[c]);
  return l;
}, m = (l, e) => r(l, M(e));
...
]), o = H((l, e) => /* @__PURE__ */ a.createElement(s, m(Z({ ref: e }, l), { weights: v })));
o.displayName = "FileSql";
export {
  o as default
};
