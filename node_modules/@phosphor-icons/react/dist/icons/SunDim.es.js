...
var t = (m, e, l) => e in m ? h(m, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : m[e] = l, n = (m, e) => {
  for (var l in e || (e = {}))
    v.call(e, l) && t(m, l, e[l]);
  if (Z)
    for (var l of Z(e))
      o.call(e, l) && t(m, l, e[l]);
  return m;
}, r = (m, e) => M(m, c(e));
...
]), A = E((m, e) => /* @__PURE__ */ a.createElement(p, r(n({ ref: e }, m), { weights: d })));
A.displayName = "SunDim";
const s = A;
export {
  s as default
};
