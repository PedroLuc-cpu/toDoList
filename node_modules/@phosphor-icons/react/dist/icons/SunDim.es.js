...
var t = (m, e, l) => e in m ? A(m, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : m[e] = l, n = (m, e) => {
  for (var l in e || (e = {}))
    c.call(e, l) && t(m, l, e[l]);
  if (Z)
    for (var l of Z(e))
...
]), d = o((m, e) => /* @__PURE__ */ a.createElement(p, r(n({ ref: e }, m), { weights: E })));
