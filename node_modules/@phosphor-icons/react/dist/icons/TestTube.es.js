...
var c = (l, a, t) => a in l ? L(l, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[a] = t, r = (l, a) => {
  for (var t in a || (a = {}))
    o.call(a, t) && c(l, t, a[t]);
  if (n)
    for (var t of n(a))
...
]), u = E((l, a) => /* @__PURE__ */ e.createElement(d, m(r({ ref: a }, l), { weights: h })));
