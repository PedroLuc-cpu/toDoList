...
var m = (V, e, l) => e in V ? H(V, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : V[e] = l, v = (V, e) => {
  for (var l in e || (e = {}))
    n.call(e, l) && m(V, l, e[l]);
  if (t)
    for (var l of t(e))
...
]), p = c((V, e) => /* @__PURE__ */ a.createElement(M, A(v({ ref: e }, V), { weights: o })));
p.displayName = "FileHtml";
export {
  p as default
};
