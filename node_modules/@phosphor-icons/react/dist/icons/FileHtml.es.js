...
var m = (V, e, l) => e in V ? Z(V, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : V[e] = l, v = (V, e) => {
  for (var l in e || (e = {}))
    r.call(e, l) && m(V, l, e[l]);
  if (t)
    for (var l of t(e))
      c.call(e, l) && m(V, l, e[l]);
  return V;
}, H = (V, e) => h(V, n(e));
...
const E = /* @__PURE__ */ new Map([
  ...
  [
    "thin",
    /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement("path", { d: "M124,152a4,4,0,0,1-4,4H108v52a4,4,0,0,1-8,0V156H88a4,4,0,0,1,0-8h32A4,4,0,0,1,124,152Zm-60-4a4,4,0,0,0-4,4v24H36V152a4,4,0,0,0-8,0v56a4,4,0,0,0,8,0V184H60v24a4,4,0,0,0,8,0V152A4,4,0,0,0,64,148Zm176,56H224V152a4,4,0,0,0-8,0v56a4,4,0,0,0,4,4h20a4,4,0,0,0,0-8Zm-46.93-55.85a4,4,0,0,0-4.5,1.79L168,184.23l-20.57-34.29A4,4,0,0,0,140,152v56a4,4,0,0,0,8,0V166.44l16.57,27.62a4,4,0,0,0,6.86,0L188,166.44V208a4,4,0,0,0,8,0V152A4,4,0,0,0,193.07,148.15Zm17.76-63A4,4,0,0,1,212,88v24a4,4,0,0,1-8,0V92H152a4,4,0,0,1-4-4V36H56a4,4,0,0,0-4,4v72a4,4,0,0,1-8,0V40A12,12,0,0,1,56,28h96a4,4,0,0,1,2.83,1.17ZM198.34,84,156,41.65V84Z" }))
  ]
]), A = M((V, e) => /* @__PURE__ */ a.createElement(o, H(v({ ref: e }, V), { weights: E })));
A.displayName = "FileHtml";
const L = A;
export {
  L as default
};
