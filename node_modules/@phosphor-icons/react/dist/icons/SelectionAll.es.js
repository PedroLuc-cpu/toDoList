...
var V = (H, e, Z) => e in H ? l(H, e, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : H[e] = Z, m = (H, e) => {
  for (var Z in e || (e = {}))
    M.call(e, Z) && V(H, Z, e[Z]);
  if (t)
    for (var Z of t(e))
      r.call(e, Z) && V(H, Z, e[Z]);
  return H;
}, A = (H, e) => n(H, v(e));
...
]), h = c((H, e) => /* @__PURE__ */ a.createElement(o, A(m({ ref: e }, H), { weights: E })));
h.displayName = "SelectionAll";
const g = h;
export {
  g as default
};
