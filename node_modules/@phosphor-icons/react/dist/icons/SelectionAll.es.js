...
var t = (H, e, Z) => e in H ? h(H, e, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : H[e] = Z, V = (H, e) => {
  for (var Z in e || (e = {}))
    v.call(e, Z) && t(H, Z, e[Z]);
  if (m)
    for (var Z of m(e))
      M.call(e, Z) && t(H, Z, e[Z]);
  return H;
}, A = (H, e) => l(H, n(e));
...
]), p = r((H, e) => /* @__PURE__ */ a.createElement(c, A(V({ ref: e }, H), { weights: o })));
p.displayName = "SelectionAll";
export {
  p as default
};
