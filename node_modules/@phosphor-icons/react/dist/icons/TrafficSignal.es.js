...
var Z = (H, e, m) => e in H ? V(H, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : H[e] = m, l = (H, e) => {
  for (var m in e || (e = {}))
    h.call(e, m) && Z(H, m, e[m]);
  if (t)
    for (var m of t(e))
      c.call(e, m) && Z(H, m, e[m]);
  return H;
}, n = (H, e) => r(H, A(e));
...
]), i = o((H, e) => /* @__PURE__ */ a.createElement(p, n(l({ ref: e }, H), { weights: E })));
