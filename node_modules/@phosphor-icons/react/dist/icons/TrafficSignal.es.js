...
var l = (H, e, t) => e in H ? r(H, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : H[e] = t, n = (H, e) => {
  for (var t in e || (e = {}))
    h.call(e, t) && l(H, t, e[t]);
  if (m)
    for (var t of m(e))
      i.call(e, t) && l(H, t, e[t]);
  return H;
}, Z = (H, e) => A(H, c(e));
...
]), V = o((H, e) => /* @__PURE__ */ a.createElement(E, Z(n({ ref: e }, H), { weights: p })));
