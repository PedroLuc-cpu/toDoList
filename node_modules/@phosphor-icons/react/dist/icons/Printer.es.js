...
var m = (e, H, t) => H in e ? c(e, H, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[H] = t, n = (e, H) => {
  for (var t in H || (H = {}))
    M.call(H, t) && m(e, t, H[t]);
  if (V)
    for (var t of V(H))
      h.call(H, t) && m(e, t, H[t]);
  return e;
}, r = (e, H) => Z(e, v(H));
...
]), l = o((e, H) => /* @__PURE__ */ a.createElement(C, r(n({ ref: H }, e), { weights: E })));
l.displayName = "Printer";
const g = l;
export {
  g as default
};
