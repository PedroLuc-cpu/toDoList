...
var l = (t, e, c) => e in t ? H(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, Z = (t, e) => {
  for (var c in e || (e = {}))
    s.call(e, c) && l(t, c, e[c]);
  if (m)
    for (var c of m(e))
      M.call(e, c) && l(t, c, e[c]);
  return t;
}, A = (t, e) => n(t, r(e));
...
]), o = h((t, e) => /* @__PURE__ */ a.createElement(V, A(Z({ ref: e }, t), { weights: v })));
o.displayName = "FileDoc";
export {
  o as default
};
