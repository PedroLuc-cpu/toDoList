...
var V = (l, e, t) => e in l ? m(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, n = (l, e) => {
  for (var t in e || (e = {}))
    Z.call(e, t) && V(l, t, e[t]);
  if (H)
    for (var t of H(e))
      o.call(e, t) && V(l, t, e[t]);
  return l;
}, r = (l, e) => c(l, g(e));
...
]), h = v((l, e) => /* @__PURE__ */ a.createElement(E, r(n({ ref: e }, l), { weights: p })));
h.displayName = "PlugCharging";
const i = h;
export {
  i as default
};
