...
var V = (l, e, t) => e in l ? r(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, n = (l, e) => {
  for (var t in e || (e = {}))
    Z.call(e, t) && V(l, t, e[t]);
  if (H)
    for (var t of H(e))
      g.call(e, t) && V(l, t, e[t]);
  return l;
}, m = (l, e) => h(l, c(e));
...
]), E = o((l, e) => /* @__PURE__ */ a.createElement(p, m(n({ ref: e }, l), { weights: v })));
E.displayName = "PlugCharging";
export {
  E as default
};
