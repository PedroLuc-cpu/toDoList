...
var m = (A, a, t) => a in A ? H(A, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : A[a] = t, M = (A, a) => {
  for (var t in a || (a = {}))
    c.call(a, t) && m(A, t, a[t]);
  if (Z)
    for (var t of Z(a))
      o.call(a, t) && m(A, t, a[t]);
  return A;
}, n = (A, a) => r(A, V(a));
