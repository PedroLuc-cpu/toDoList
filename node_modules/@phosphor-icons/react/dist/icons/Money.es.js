...
var m = (A, a, t) => a in A ? l(A, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : A[a] = t, M = (A, a) => {
  for (var t in a || (a = {}))
    V.call(a, t) && m(A, t, a[t]);
  if (Z)
    for (var t of Z(a))
...
]), E = o((A, a) => /* @__PURE__ */ e.createElement(h, n(M({ ref: a }, A), { weights: p })));
E.displayName = "Money";
export {
  E as default
};
