...
var V = (t, e, m) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, n = (t, e) => {
  for (var m in e || (e = {}))
    v.call(e, m) && V(t, m, e[m]);
  if (H)
    for (var m of H(e))
...
]), Z = o((t, e) => /* @__PURE__ */ a.createElement(E, h(n({ ref: e }, t), { weights: p })));
Z.displayName = "Kanban";
const u = Z;
export {
  u as default
};
