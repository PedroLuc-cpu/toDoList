...
var A = (e, l, c) => l in e ? n(e, l, { enumerable: !0, configurable: !0, writable: !0, value: c }) : e[l] = c, L = (e, l) => {
  for (var c in l || (l = {}))
    h.call(l, c) && A(e, c, l[c]);
  if (t)
    for (var c of t(l))
      o.call(l, c) && A(e, c, l[c]);
  return e;
}, m = (e, l) => r(e, Z(l));
...
]), i = p((e, l) => /* @__PURE__ */ a.createElement(E, m(L({ ref: l }, e), { weights: d })));
