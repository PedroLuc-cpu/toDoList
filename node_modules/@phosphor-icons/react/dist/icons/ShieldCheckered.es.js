...
var l = (a, t, c) => t in a ? r(a, t, { enumerable: !0, configurable: !0, writable: !0, value: c }) : a[t] = c, h = (a, t) => {
  for (var c in t || (t = {}))
    v.call(t, c) && l(a, c, t[c]);
  if (m)
    for (var c of m(t))
      M.call(t, c) && l(a, c, t[c]);
  return a;
}, n = (a, t) => Z(a, H(t));
...
]), C = V((a, t) => /* @__PURE__ */ e.createElement(d, n(h({ ref: t }, a), { weights: A })));
C.displayName = "ShieldCheckered";
export {
  C as default
};
