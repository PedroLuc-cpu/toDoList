...
var A = (t, e, l) => e in t ? o(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, m = (t, e) => {
  for (var l in e || (e = {}))
    h.call(e, l) && A(t, l, e[l]);
  if (n)
    for (var l of n(e))
      v.call(e, l) && A(t, l, e[l]);
  return t;
}, r = (t, e) => Z(t, M(e));
...
]), c = E((t, e) => /* @__PURE__ */ a.createElement(p, r(m({ ref: e }, t), { weights: d })));
c.displayName = "AmazonLogo";
const u = c;
export {
  u as default
};
