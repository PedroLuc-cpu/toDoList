...
var H = (l, e, t) => e in l ? c(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, r = (l, e) => {
  for (var t in e || (e = {}))
    p.call(e, t) && H(l, t, e[t]);
  if (n)
    for (var t of n(e))
      d.call(e, t) && H(l, t, e[t]);
  return l;
}, m = (l, e) => M(l, Z(e));
...
]), A = o((l, e) => /* @__PURE__ */ a.createElement(E, m(r({ ref: e }, l), { weights: g })));
A.displayName = "HandbagSimple";
const s = A;
export {
  s as default
};
