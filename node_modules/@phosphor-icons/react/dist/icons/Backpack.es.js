...
var h = (t, e, H) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, m = (t, e) => {
  for (var H in e || (e = {}))
    r.call(e, H) && h(t, H, e[H]);
  if (V)
    for (var H of V(e))
...
]), Z = M((t, e) => /* @__PURE__ */ a.createElement(p, A(m({ ref: e }, t), { weights: o })));
Z.displayName = "Backpack";
const u = Z;
export {
  u as default
};
