...
var Z = (t, a, l) => a in t ? A(t, a, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[a] = l, h = (t, a) => {
  for (var l in a || (a = {}))
    H.call(a, l) && Z(t, l, a[l]);
  if (m)
    for (var l of m(a))
...
]), L = o((t, a) => /* @__PURE__ */ e.createElement(p, c(h({ ref: a }, t), { weights: E })));
L.displayName = "Parachute";
export {
  L as default
};
