...
var l = (t, e, A) => e in t ? m(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, n = (t, e) => {
  for (var A in e || (e = {}))
    o.call(e, A) && l(t, A, e[A]);
  if (v)
    for (var A of v(e))
      E.call(e, A) && l(t, A, e[A]);
  return t;
}, r = (t, e) => h(t, c(e));
...
]), H = p((t, e) => /* @__PURE__ */ a.createElement(M, r(n({ ref: e }, t), { weights: d })));
H.displayName = "GithubLogo";
const Z = H;
export {
  Z as default
};
