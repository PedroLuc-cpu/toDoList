...
var H = (t, e, l) => e in t ? m(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, A = (t, e) => {
  for (var l in e || (e = {}))
    L.call(e, l) && H(t, l, e[l]);
  if (V)
    for (var l of V(e))
...
]), o = h((t, e) => /* @__PURE__ */ a.createElement(c, Z(A({ ref: e }, t), { weights: d })));
o.displayName = "ShirtFolded";
export {
  o as default
};
