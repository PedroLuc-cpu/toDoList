...
var c = (t, e, m) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, l = (t, e) => {
  for (var m in e || (e = {}))
    E.call(e, m) && c(t, m, e[m]);
  if (n)
    for (var m of n(e))
      d.call(e, m) && c(t, m, e[m]);
  return t;
}, r = (t, e) => p(t, o(e));
...
]), A = i((t, e) => /* @__PURE__ */ a.createElement(M, r(l({ ref: e }, t), { weights: h })));
A.displayName = "MapPin";
const s = A;
export {
  s as default
};
