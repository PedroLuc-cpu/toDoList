...
var A = (t, e, r) => e in t ? H(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, n = (t, e) => {
  for (var r in e || (e = {}))
    M.call(e, r) && A(t, r, e[r]);
  if (l)
    for (var r of l(e))
...
]), E = h((t, e) => /* @__PURE__ */ a.createElement(o, m(n({ ref: e }, t), { weights: p })));
E.displayName = "UserSquare";
export {
  E as default
};
