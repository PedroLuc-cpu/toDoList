...
var n = (t, e, r) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, A = (t, e) => {
  for (var r in e || (e = {}))
    c.call(e, r) && n(t, r, e[r]);
  if (l)
    for (var r of l(e))
...
]), H = o((t, e) => /* @__PURE__ */ a.createElement(E, m(A({ ref: e }, t), { weights: p })));
H.displayName = "UserSquare";
const g = H;
export {
  g as default
};
