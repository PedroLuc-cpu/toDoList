...
var m = (e, c, t) => c in e ? Z(e, c, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[c] = t, A = (e, c) => {
  for (var t in c || (c = {}))
    h.call(c, t) && m(e, t, c[t]);
  if (l)
    for (var t of l(c))
      M.call(c, t) && m(e, t, c[t]);
  return e;
}, n = (e, c) => r(e, C(c));
...
]), p = s((e, c) => /* @__PURE__ */ a.createElement(V, n(A({ ref: c }, e), { weights: o })));
p.displayName = "FileCss";
export {
  p as default
};
