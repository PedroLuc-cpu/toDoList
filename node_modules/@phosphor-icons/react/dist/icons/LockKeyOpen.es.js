...
var n = (t, e, V) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, l = (t, e) => {
  for (var V in e || (e = {}))
    o.call(e, V) && n(t, V, e[V]);
  if (m)
    for (var V of m(e))
      p.call(e, V) && n(t, V, e[V]);
  return t;
}, H = (t, e) => A(t, Z(e));
...
]), c = E((t, e) => /* @__PURE__ */ a.createElement(d, H(l({ ref: e }, t), { weights: h })));
c.displayName = "LockKeyOpen";
const i = c;
export {
  i as default
};
