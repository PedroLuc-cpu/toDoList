...
var A = (t, a, l) => a in t ? Z(t, a, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[a] = l, n = (t, a) => {
  for (var l in a || (a = {}))
    g.call(a, l) && A(t, l, a[l]);
  if (m)
    for (var l of m(a))
      L.call(a, l) && A(t, l, a[l]);
  return t;
}, r = (t, a) => o(t, h(a));
...
]), c = E((t, a) => /* @__PURE__ */ e.createElement(p, r(n({ ref: a }, t), { weights: M })));
c.displayName = "GoogleChromeLogo";
const i = c;
export {
  i as default
};
