...
var A = (t, a, m) => a in t ? c(t, a, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[a] = m, n = (t, a) => {
  for (var m in a || (a = {}))
    h.call(a, m) && A(t, m, a[m]);
  if (l)
    for (var m of l(a))
      p.call(a, m) && A(t, m, a[m]);
  return t;
}, r = (t, a) => Z(t, o(a));
...
]), M = E((t, a) => /* @__PURE__ */ e.createElement(L, r(n({ ref: a }, t), { weights: g })));
M.displayName = "GoogleChromeLogo";
export {
  M as default
};
