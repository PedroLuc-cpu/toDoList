...
var L = (l, a, t) => a in l ? Z(l, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[a] = t, n = (l, a) => {
  for (var t in a || (a = {}))
    M.call(a, t) && L(l, t, a[t]);
  if (m)
    for (var t of m(a))
      p.call(a, t) && L(l, t, a[t]);
  return l;
}, r = (l, a) => c(l, o(a));
...
]), d = E((l, a) => /* @__PURE__ */ e.createElement(g, r(n({ ref: a }, l), { weights: A })));
