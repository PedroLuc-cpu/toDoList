...
var m = (Z, e, A) => e in Z ? n(Z, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : Z[e] = A, l = (Z, e) => {
  for (var A in e || (e = {}))
    h.call(e, A) && m(Z, A, e[A]);
  if (t)
    for (var A of t(e))
      o.call(e, A) && m(Z, A, e[A]);
  return Z;
}, M = (Z, e) => r(Z, c(e));
...
]), d = p((Z, e) => /* @__PURE__ */ a.createElement(L, M(l({ ref: e }, Z), { weights: E })));
d.displayName = "PokerChip";
export {
  d as default
};
