...
var c = (t, e, m) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, V = (t, e) => {
  for (var m in e || (e = {}))
    h.call(e, m) && c(t, m, e[m]);
  if (l)
    for (var m of l(e))
...
]), n = E((t, e) => /* @__PURE__ */ a.createElement(H, Z(V({ ref: e }, t), { weights: M })));
n.displayName = "Skull";
const u = n;
export {
  u as default
