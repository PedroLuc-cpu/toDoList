...
var c = (t, e, m) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, V = (t, e) => {
  for (var m in e || (e = {}))
    C.call(e, m) && c(t, m, e[m]);
  if (l)
    for (var m of l(e))
...
]), H = o((t, e) => /* @__PURE__ */ a.createElement(p, Z(V({ ref: e }, t), { weights: E })));
H.displayName = "Skull";
export {
  H as default
};
