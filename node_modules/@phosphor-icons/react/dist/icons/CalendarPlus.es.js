...
var l = (e, V, H) => V in e ? m(e, V, { enumerable: !0, configurable: !0, writable: !0, value: H }) : e[V] = H, n = (e, V) => {
  for (var H in V || (V = {}))
    A.call(V, H) && l(e, H, V[H]);
  if (t)
    for (var H of t(V))
      c.call(V, H) && l(e, H, V[H]);
  return e;
}, h = (e, V) => v(e, Z(V));
...
]), r = M((e, V) => /* @__PURE__ */ a.createElement(d, h(n({ ref: V }, e), { weights: o })));
r.displayName = "CalendarPlus";
const s = r;
export {
  s as default
};
