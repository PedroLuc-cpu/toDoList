...
var l = (e, V, H) => V in e ? r(e, V, { enumerable: !0, configurable: !0, writable: !0, value: H }) : e[V] = H, h = (e, V) => {
  for (var H in V || (V = {}))
    Z.call(V, H) && l(e, H, V[H]);
  if (t)
    for (var H of t(V))
...
]), o = M((e, V) => /* @__PURE__ */ a.createElement(c, n(h({ ref: V }, e), { weights: d })));
o.displayName = "CalendarPlus";
export {
  o as default
};
