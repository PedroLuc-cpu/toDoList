...
var l = (e, H, t) => H in e ? n(e, H, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[H] = t, Z = (e, H) => {
  for (var t in H || (H = {}))
    V.call(H, t) && l(e, t, H[t]);
  if (h)
    for (var t of h(H))
...
]), o = L((e, H) => /* @__PURE__ */ a.createElement(c, m(Z({ ref: H }, e), { weights: v })));
o.displayName = "Taxi";
export {
  o as default
};
