...
var r = (t, e, H) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, Z = (t, e) => {
  for (var H in e || (e = {}))
    v.call(e, H) && r(t, H, e[H]);
  if (m)
    for (var H of m(e))
      M.call(e, H) && r(t, H, e[H]);
  return t;
}, l = (t, e) => V(t, c(e));
...
const o = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement("path", { d: "M208,36H48A20,20,0,0,0,28,56V200a20,20,0,0,0,20,20H208a20,20,0,0,0,20-20V56A20,20,0,0,0,208,36Zm-4,24v56H52V60ZM52,196V140H204v56ZM160,88a16,16,0,1,1,16,16A16,16,0,0,1,160,88Zm32,80a16,16,0,1,1-16-16A16,16,0,0,1,192,168Z" }))
  ],
  [
    "duotone",
...
]), n = d((t, e) => /* @__PURE__ */ a.createElement(E, l(Z({ ref: e }, t), { weights: o })));
n.displayName = "HardDrives";
const s = n;
export {
  s as default
};
