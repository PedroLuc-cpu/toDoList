...
var n = (t, e, m) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, l = (t, e) => {
  for (var m in e || (e = {}))
    M.call(e, m) && n(t, m, e[m]);
  if (A)
    for (var m of A(e))
      g.call(e, m) && n(t, m, e[m]);
  return t;
}, r = (t, e) => c(t, o(e));
...
]), Z = E((t, e) => /* @__PURE__ */ a.createElement(p, r(l({ ref: e }, t), { weights: d })));
Z.displayName = "InstagramLogo";
const u = Z;
export {
  u as default
};
