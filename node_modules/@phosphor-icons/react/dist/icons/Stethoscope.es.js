...
var l = (t, e, V) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, n = (t, e) => {
  for (var V in e || (e = {}))
    o.call(e, V) && l(t, V, e[V]);
  if (c)
    for (var V of c(e))
      Z.call(e, V) && l(t, V, e[V]);
  return t;
}, m = (t, e) => h(t, H(e));
...
const d = /* @__PURE__ */ new Map([
  ...
  [
    "thin",
    /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement("path", { d: "M208,152a8,8,0,1,1-8-8A8,8,0,0,1,208,152Zm-4.17,35.79A44.06,44.06,0,0,1,160,228H136a44.05,44.05,0,0,1-44-44V139.85A60,60,0,0,1,36,80V40A12,12,0,0,1,48,28H64a4,4,0,0,1,0,8H48a4,4,0,0,0-4,4V80a52,52,0,0,0,52.69,52C125,131.63,148,107.93,148,79.17V40a4,4,0,0,0-4-4H128a4,4,0,0,1,0-8h16a12,12,0,0,1,12,12V79.17c0,32-24.84,58.59-56,60.69V184a36,36,0,0,0,36,36h24a36.05,36.05,0,0,0,35.8-32.25,36,36,0,1,1,8,0ZM228,152a28,28,0,1,0-28,28A28,28,0,0,0,228,152Z" }))
  ]
]), A = p((t, e) => /* @__PURE__ */ a.createElement(E, m(n({ ref: e }, t), { weights: d })));
A.displayName = "Stethoscope";
const u = A;
export {
  u as default
};
