...
var V = (H, e, t) => e in H ? v(H, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : H[e] = t, Z = (H, e) => {
  for (var t in e || (e = {}))
    A.call(e, t) && V(H, t, e[t]);
  if (l)
    for (var t of l(e))
...
]), h = c((H, e) => /* @__PURE__ */ a.createElement(o, m(Z({ ref: e }, H), { weights: L })));
h.displayName = "MicrosoftExcelLogo";
const g = h;
export {
  g as default
};
