...
var l = (H, e, t) => e in H ? h(H, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : H[e] = t, m = (H, e) => {
  for (var t in e || (e = {}))
...
]), L = M((H, e) => /* @__PURE__ */ a.createElement(c, Z(m({ ref: e }, H), { weights: o })));
L.displayName = "MicrosoftExcelLogo";
export {
  L as default
};
