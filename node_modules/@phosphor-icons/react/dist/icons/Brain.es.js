...
var m = (A, e, t) => e in A ? l(A, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : A[e] = t, n = (A, e) => {
  for (var t in e || (e = {}))
    c.call(e, t) && m(A, t, e[t]);
  if (h)
    for (var t of h(e))
      M.call(e, t) && m(A, t, e[t]);
  return A;
}, v = (A, e) => r(A, Z(e));
...
]), V = o((A, e) => /* @__PURE__ */ a.createElement(E, v(n({ ref: e }, A), { weights: p })));
V.displayName = "Brain";
const g = V;
export {
  g as default
