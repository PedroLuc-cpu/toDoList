...
var v = (t, e, l) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, h = (t, e) => {
  for (var l in e || (e = {}))
    c.call(e, l) && v(t, l, e[l]);
  if (H)
    for (var l of H(e))
      A.call(e, l) && v(t, l, e[l]);
  return t;
}, n = (t, e) => V(t, Z(e));
...
]), m = M((t, e) => /* @__PURE__ */ a.createElement(o, n(h({ ref: e }, t), { weights: E })));
m.displayName = "Usb";
const g = m;
export {
  g as default
