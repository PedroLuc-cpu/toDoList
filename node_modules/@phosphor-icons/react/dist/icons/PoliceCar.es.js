...
var Z = (e, H, t) => H in e ? n(e, H, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[H] = t, m = (e, H) => {
  for (var t in H || (H = {}))
    V.call(H, t) && Z(e, t, H[t]);
  if (h)
    for (var t of h(H))
...
]), p = c((e, H) => /* @__PURE__ */ a.createElement(v, l(m({ ref: H }, e), { weights: o })));
p.displayName = "PoliceCar";
export {
  p as default
};
