...
var n = (t, e, A) => e in t ? V(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, r = (t, e) => {
  for (var A in e || (e = {}))
    h.call(e, A) && n(t, A, e[A]);
  if (l)
    for (var A of l(e))
...
]), M = p((t, e) => /* @__PURE__ */ a.createElement(v, H(r({ ref: e }, t), { weights: E })));
M.displayName = "PuzzlePiece";
export {
  M as default
};
