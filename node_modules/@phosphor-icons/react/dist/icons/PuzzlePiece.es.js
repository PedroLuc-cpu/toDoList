...
var n = (t, e, A) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, H = (t, e) => {
  for (var A in e || (e = {}))
    o.call(e, A) && n(t, A, e[A]);
  if (l)
    for (var A of l(e))
...
]), V = E((t, e) => /* @__PURE__ */ a.createElement(p, r(H({ ref: e }, t), { weights: M })));
