...
var m = (t, e, Z) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : t[e] = Z, n = (t, e) => {
  for (var Z in e || (e = {}))
    V.call(e, Z) && m(t, Z, e[Z]);
  if (l)
    for (var Z of l(e))
      h.call(e, Z) && m(t, Z, e[Z]);
  return t;
}, M = (t, e) => c(t, H(e));
...
]), r = p((t, e) => /* @__PURE__ */ a.createElement(L, M(n({ ref: e }, t), { weights: o })));
