...
var H = (e, l, t) => l in e ? h(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, m = (e, l) => {
  for (var t in l || (l = {}))
    L.call(l, t) && H(e, t, l[t]);
  if (A)
    for (var t of A(l))
      o.call(l, t) && H(e, t, l[t]);
  return e;
}, n = (e, l) => c(e, Z(l));
...
]), r = E((e, l) => /* @__PURE__ */ a.createElement(p, n(m({ ref: l }, e), { weights: d })));
r.displayName = "Shuffle";
const g = r;
export {
  g as default
};
