...
var r = (e, l, t) => l in e ? o(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, m = (e, l) => {
  for (var t in l || (l = {}))
    h.call(l, t) && r(e, t, l[t]);
  if (n)
    for (var t of n(l))
      V.call(l, t) && r(e, t, l[t]);
  return e;
}, L = (e, l) => M(e, Z(l));
...
]), c = E((e, l) => /* @__PURE__ */ a.createElement(p, L(m({ ref: l }, e), { weights: d })));
c.displayName = "BluetoothSlash";
const g = c;
export {
  g as default
};
