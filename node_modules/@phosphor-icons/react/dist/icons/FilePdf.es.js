...
var m = (t, e, h) => e in t ? v(t, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : t[e] = h, Z = (t, e) => {
  for (var h in e || (e = {}))
    n.call(e, h) && m(t, h, e[h]);
  if (H)
    for (var h of H(e))
...
]), o = M((t, e) => /* @__PURE__ */ a.createElement(c, l(Z({ ref: e }, t), { weights: d })));
o.displayName = "FilePdf";
export {
  o as default
};
