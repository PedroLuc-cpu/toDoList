...
var r = (t, a, n) => a in t ? c(t, a, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[a] = n, m = (t, a) => {
  for (var n in a || (a = {}))
    h.call(a, n) && r(t, n, a[n]);
  if (l)
    for (var n of l(a))
...
]), g = E((t, a) => /* @__PURE__ */ e.createElement(L, o(m({ ref: a }, t), { weights: i })));
g.displayName = "ArrowLineDownRight";
export {
  g as default
};
