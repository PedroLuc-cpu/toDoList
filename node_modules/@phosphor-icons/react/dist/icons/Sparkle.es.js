...
var V = (e, l, t) => l in e ? Z(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, n = (e, l) => {
  for (var t in l || (l = {}))
    A.call(l, t) && V(e, t, l[t]);
  if (h)
    for (var t of h(l))
      L.call(l, t) && V(e, t, l[t]);
  return e;
}, r = (e, l) => c(e, M(l));
...
]), m = p((e, l) => /* @__PURE__ */ a.createElement(H, r(n({ ref: l }, e), { weights: o })));
m.displayName = "Sparkle";
const g = m;
export {
  g as default
};
