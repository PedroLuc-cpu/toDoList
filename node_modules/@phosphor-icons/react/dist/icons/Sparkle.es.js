...
var V = (e, l, t) => l in e ? m(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, n = (e, l) => {
  for (var t in l || (l = {}))
    c.call(l, t) && V(e, t, l[t]);
  if (h)
    for (var t of h(l))
...
]), o = L((e, l) => /* @__PURE__ */ a.createElement(p, r(n({ ref: l }, e), { weights: H })));
o.displayName = "Sparkle";
export {
  o as default
};
