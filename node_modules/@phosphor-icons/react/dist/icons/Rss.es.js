...
var m = (t, e, A) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, n = (t, e) => {
  for (var A in e || (e = {}))
    E.call(e, A) && m(t, A, e[A]);
  if (l)
    for (var A of l(e))
      p.call(e, A) && m(t, A, e[A]);
  return t;
}, r = (t, e) => M(t, o(e));
...
]), Z = s((t, e) => /* @__PURE__ */ a.createElement(d, r(n({ ref: e }, t), { weights: h })));
Z.displayName = "Rss";
const f = Z;
export {
  f as default
