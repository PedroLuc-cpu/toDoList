...
var n = (t, a, r) => a in t ? h(t, a, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[a] = r, m = (t, a) => {
  for (var r in a || (a = {}))
    M.call(a, r) && n(t, r, a[r]);
  if (l)
    for (var r of l(a))
...
]), E = o((t, a) => /* @__PURE__ */ e.createElement(p, A(m({ ref: a }, t), { weights: d })));
E.displayName = "ChatsTeardrop";
export {
  E as default
};
