...
var h = (t, e, H) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, A = (t, e) => {
  for (var H in e || (e = {}))
    Z.call(e, H) && h(t, H, e[H]);
  if (V)
    for (var H of V(e))
      M.call(e, H) && h(t, H, e[H]);
  return t;
}, c = (t, e) => r(t, m(e));
...
]), l = o((t, e) => /* @__PURE__ */ a.createElement(p, c(A({ ref: e }, t), { weights: E })));
l.displayName = "Trophy";
const u = l;
export {
  u as default
};
