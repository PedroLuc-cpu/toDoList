...
var r = (l, e, t) => e in l ? Z(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, m = (l, e) => {
  for (var t in e || (e = {}))
    V.call(e, t) && r(l, t, e[t]);
  if (n)
    for (var t of n(e))
      L.call(e, t) && r(l, t, e[t]);
  return l;
}, H = (l, e) => c(l, M(e));
...
]), o = i((l, e) => /* @__PURE__ */ a.createElement(E, H(m({ ref: e }, l), { weights: h })));
o.displayName = "ArrowsInLineHorizontal";
const g = o;
export {
  g as default
};
