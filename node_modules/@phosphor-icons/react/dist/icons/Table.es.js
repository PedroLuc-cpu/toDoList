...
var Z = (a, H, t) => H in a ? r(a, H, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[H] = t, l = (a, H) => {
  for (var t in H || (H = {}))
    M.call(H, t) && Z(a, t, H[t]);
  if (m)
    for (var t of m(H))
      c.call(H, t) && Z(a, t, H[t]);
  return a;
}, n = (a, H) => V(a, v(H));
...
]), d = o((a, H) => /* @__PURE__ */ e.createElement(p, n(l({ ref: H }, a), { weights: E })));
d.displayName = "Table";
export {
  d as default
};
