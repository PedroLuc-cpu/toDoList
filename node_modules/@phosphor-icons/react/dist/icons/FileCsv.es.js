...
var m = (c, e, l) => e in c ? Z(c, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : c[e] = l, A = (c, e) => {
  for (var l in e || (e = {}))
    M.call(e, l) && m(c, l, e[l]);
  if (t)
    for (var l of t(e))
      h.call(e, l) && m(c, l, e[l]);
  return c;
}, n = (c, e) => r(c, V(e));
...
]), s = C((c, e) => /* @__PURE__ */ a.createElement(o, n(A({ ref: e }, c), { weights: p })));
s.displayName = "FileCsv";
export {
  s as default
};
