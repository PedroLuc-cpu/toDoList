...
var n = (t, e, A) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, m = (t, e) => {
  for (var A in e || (e = {}))
    E.call(e, A) && n(t, A, e[A]);
  if (l)
    for (var A of l(e))
      p.call(e, A) && n(t, A, e[A]);
  return t;
}, r = (t, e) => o(t, h(e));
...
]), V = v((t, e) => /* @__PURE__ */ a.createElement(d, r(m({ ref: e }, t), { weights: g })));
V.displayName = "TiktokLogo";
const M = V;
export {
  M as default
};
