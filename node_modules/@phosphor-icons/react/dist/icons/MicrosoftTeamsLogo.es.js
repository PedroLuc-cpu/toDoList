...
var m = (t, e, A) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, Z = (t, e) => {
  for (var A in e || (e = {}))
    M.call(e, A) && m(t, A, e[A]);
  if (H)
    for (var A of H(e))
...
]), p = c((t, e) => /* @__PURE__ */ a.createElement(o, h(Z({ ref: e }, t), { weights: v })));
p.displayName = "MicrosoftTeamsLogo";
export {
  p as default
};
