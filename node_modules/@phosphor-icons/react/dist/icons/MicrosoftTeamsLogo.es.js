...
var m = (t, e, A) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, Z = (t, e) => {
  for (var A in e || (e = {}))
    V.call(e, A) && m(t, A, e[A]);
  if (H)
    for (var A of H(e))
...
]), l = c((t, e) => /* @__PURE__ */ a.createElement(v, h(Z({ ref: e }, t), { weights: E })));
l.displayName = "MicrosoftTeamsLogo";
const g = l;
export {
  g as default
};
