...
var c = (t, e, A) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, l = (t, e) => {
  for (var A in e || (e = {}))
    p.call(e, A) && c(t, A, e[A]);
  if (m)
    for (var A of m(e))
      E.call(e, A) && c(t, A, e[A]);
  return t;
}, Z = (t, e) => r(t, o(e));
...
]), g = M((t, e) => /* @__PURE__ */ a.createElement(d, Z(l({ ref: e }, t), { weights: h })));
g.displayName = "Baseball";
export {
  g as default
};
