...
var A = (t, e, m) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, H = (t, e) => {
  for (var m in e || (e = {}))
    M.call(e, m) && A(t, m, e[m]);
  if (Z)
    for (var m of Z(e))
...
]), V = o((t, e) => /* @__PURE__ */ a.createElement(v, h(H({ ref: e }, t), { weights: E })));
V.displayName = "SlackLogo";
const u = V;
export {
  u as default
};
