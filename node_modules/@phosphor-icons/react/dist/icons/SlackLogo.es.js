...
var A = (t, e, m) => e in t ? V(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, H = (t, e) => {
  for (var m in e || (e = {}))
    r.call(e, m) && A(t, m, e[m]);
  if (Z)
    for (var m of Z(e))
...
]), p = c((t, e) => /* @__PURE__ */ a.createElement(o, h(H({ ref: e }, t), { weights: v })));
p.displayName = "SlackLogo";
export {
  p as default
};
