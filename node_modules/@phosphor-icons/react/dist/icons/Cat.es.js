...
var c = (t, e, l) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, m = (t, e) => {
  for (var l in e || (e = {}))
    v.call(e, l) && c(t, l, e[l]);
  if (V)
    for (var l of V(e))
...
]), n = E((t, e) => /* @__PURE__ */ a.createElement(M, A(m({ ref: e }, t), { weights: p })));
n.displayName = "Cat";
const g = n;
export {
  g as default
