...
var m = (A, a, Z) => a in A ? n(A, a, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : A[a] = Z, l = (A, a) => {
  for (var Z in a || (a = {}))
    h.call(a, Z) && m(A, Z, a[Z]);
  if (t)
    for (var Z of t(a))
      c.call(a, Z) && m(A, Z, a[Z]);
  return A;
}, M = (A, a) => r(A, H(a));
...
]), d = o((A, a) => /* @__PURE__ */ e.createElement(p, M(l({ ref: a }, A), { weights: E })));
d.displayName = "Basketball";
export {
  d as default
};
