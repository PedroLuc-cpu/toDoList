...
var m = (h, e, t) => e in h ? A(h, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : h[e] = t, H = (h, e) => {
  for (var t in e || (e = {}))
    l.call(e, t) && m(h, t, e[t]);
  if (V)
    for (var t of V(e))
      r.call(e, t) && m(h, t, e[t]);
  return h;
}, v = (h, e) => Z(h, n(e));
...
]), d = M((h, e) => /* @__PURE__ */ a.createElement(c, v(H({ ref: e }, h), { weights: o })));
d.displayName = "SelectionForeground";
export {
  d as default
};
