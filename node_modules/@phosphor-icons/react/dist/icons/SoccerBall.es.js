...
var t = (a, e, Z) => e in a ? M(a, e, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : a[e] = Z, A = (a, e) => {
  for (var Z in e || (e = {}))
    r.call(e, Z) && t(a, Z, e[Z]);
  if (m)
    for (var Z of m(e))
      h.call(e, Z) && t(a, Z, e[Z]);
  return a;
}, L = (a, e) => c(a, n(e));
...
]), H = o((a, e) => /* @__PURE__ */ l.createElement(p, L(A({ ref: e }, a), { weights: E })));
