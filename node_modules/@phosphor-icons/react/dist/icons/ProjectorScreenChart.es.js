...
var H = (t, e, V) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, r = (t, e) => {
  for (var V in e || (e = {}))
    c.call(e, V) && H(t, V, e[V]);
  if (m)
    for (var V of m(e))
      h.call(e, V) && H(t, V, e[V]);
  return t;
}, Z = (t, e) => A(t, v(e));
...
]), n = M((t, e) => /* @__PURE__ */ a.createElement(o, Z(r({ ref: e }, t), { weights: E })));
n.displayName = "ProjectorScreenChart";
const u = n;
export {
  u as default
};
