...
var n = (t, a, l) => a in t ? V(t, a, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[a] = l, m = (t, a) => {
  for (var l in a || (a = {}))
...
]), Z = E((t, a) => /* @__PURE__ */ e.createElement(d, h(m({ ref: a }, t), { weights: H })));
Z.displayName = "ArrowFatLeft";
export {
  Z as default
};
