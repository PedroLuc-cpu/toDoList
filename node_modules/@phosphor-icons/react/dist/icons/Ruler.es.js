...
var n = (l, e, t) => e in l ? o(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, r = (l, e) => {
  for (var t in e || (e = {}))
    d.call(e, t) && n(l, t, e[t]);
  if (L)
    for (var t of L(e))
      u.call(e, t) && n(l, t, e[t]);
  return l;
}, m = (l, e) => E(l, p(e));
...
]), c = M((l, e) => /* @__PURE__ */ a.createElement(Z, m(r({ ref: e }, l), { weights: h })));
c.displayName = "Ruler";
const s = c;
export {
  s as default
