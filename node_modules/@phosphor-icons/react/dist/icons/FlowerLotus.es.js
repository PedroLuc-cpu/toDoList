...
var m = (e, c, t) => c in e ? n(e, c, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[c] = t, Z = (e, c) => {
  for (var t in c || (c = {}))
    M.call(c, t) && m(e, t, c[t]);
  if (A)
    for (var t of A(c))
      o.call(c, t) && m(e, t, c[t]);
  return e;
}, l = (e, c) => r(e, C(c));
...
]), d = s((e, c) => /* @__PURE__ */ a.createElement(p, l(Z({ ref: c }, e), { weights: E })));
d.displayName = "FlowerLotus";
export {
  d as default
};
