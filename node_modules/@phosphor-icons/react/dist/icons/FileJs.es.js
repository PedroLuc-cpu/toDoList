...
var n = (t, e, c) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, m = (t, e) => {
  for (var c in e || (e = {}))
    M.call(e, c) && n(t, c, e[c]);
  if (l)
    for (var c of l(e))
      H.call(e, c) && n(t, c, e[c]);
  return t;
}, r = (t, e) => Z(t, A(e));
...
]), V = o((t, e) => /* @__PURE__ */ a.createElement(E, r(m({ ref: e }, t), { weights: p })));
V.displayName = "FileJs";
const s = V;
export {
  s as default
};
