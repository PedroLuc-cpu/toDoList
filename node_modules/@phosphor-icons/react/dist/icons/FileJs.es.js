...
var n = (t, e, c) => e in t ? V(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, m = (t, e) => {
  for (var c in e || (e = {}))
    A.call(e, c) && n(t, c, e[c]);
  if (l)
    for (var c of l(e))
...
]), E = H((t, e) => /* @__PURE__ */ a.createElement(o, r(m({ ref: e }, t), { weights: p })));
E.displayName = "FileJs";
export {
  E as default
};
