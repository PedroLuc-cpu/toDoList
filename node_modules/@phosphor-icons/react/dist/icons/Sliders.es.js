...
var Z = (V, e, t) => e in V ? r(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, l = (V, e) => {
  for (var t in e || (e = {}))
    v.call(e, t) && Z(V, t, e[t]);
  if (m)
    for (var t of m(e))
      d.call(e, t) && Z(V, t, e[t]);
  return V;
}, n = (V, e) => A(V, c(e));
...
]), M = o((V, e) => /* @__PURE__ */ a.createElement(p, n(l({ ref: e }, V), { weights: E })));
