...
var l = (V, e, t) => e in V ? A(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, Z = (V, e) => {
  for (var t in e || (e = {}))
    d.call(e, t) && l(V, t, e[t]);
  if (m)
    for (var t of m(e))
      o.call(e, t) && l(V, t, e[t]);
  return V;
}, n = (V, e) => c(V, v(e));
...
]), r = E((V, e) => /* @__PURE__ */ a.createElement(M, n(Z({ ref: e }, V), { weights: p })));
