...
var m = (t, e, A) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, H = (t, e) => {
  for (var A in e || (e = {}))
    V.call(e, A) && m(t, A, e[A]);
  if (h)
    for (var A of h(e))
      r.call(e, A) && m(t, A, e[A]);
  return t;
}, Z = (t, e) => l(t, n(e));
...
]), p = v((t, e) => /* @__PURE__ */ a.createElement(M, Z(H({ ref: e }, t), { weights: o })));
p.displayName = "Gift";
export {
  p as default
};
