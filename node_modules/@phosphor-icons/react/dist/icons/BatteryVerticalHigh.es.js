...
var H = (t, e, h) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : t[e] = h, l = (t, e) => {
  for (var h in e || (e = {}))
    c.call(e, h) && H(t, h, e[h]);
  if (m)
    for (var h of m(e))
      i.call(e, h) && H(t, h, e[h]);
  return t;
}, r = (t, e) => A(t, V(e));
...
const p = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a.createElement("path", { d: "M88,8a8,8,0,0,1,8-8h64a8,8,0,0,1,0,16H96A8,8,0,0,1,88,8ZM200,56V224a24,24,0,0,1-24,24H80a24,24,0,0,1-24-24V56A24,24,0,0,1,80,32h96A24,24,0,0,1,200,56Zm-16,0a8,8,0,0,0-8-8H80a8,8,0,0,0-8,8V224a8,8,0,0,0,8,8h96a8,8,0,0,0,8-8Zm-24,56H96a8,8,0,0,0,0,16h64a8,8,0,0,0,0-16Zm0,40H96a8,8,0,0,0,0,16h64a8,8,0,0,0,0-16Zm0,40H96a8,8,0,0,0,0,16h64a8,8,0,0,0,0-16Z" }))
  ],
  [
    "fill",
...
]), Z = o((t, e) => /* @__PURE__ */ a.createElement(E, r(l({ ref: e }, t), { weights: p })));
Z.displayName = "BatteryVerticalHigh";
const u = Z;
export {
  u as default
};
