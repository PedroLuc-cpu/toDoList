...
var A = (t, e, l) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, n = (t, e) => {
  for (var l in e || (e = {}))
    M.call(e, l) && A(t, l, e[l]);
  if (m)
    for (var l of m(e))
      c.call(e, l) && A(t, l, e[l]);
  return t;
}, r = (t, e) => h(t, V(e));
...
]), H = L((t, e) => /* @__PURE__ */ a.createElement(p, r(n({ ref: e }, t), { weights: i })));
H.displayName = "TrainSimple";
const v = H;
export {
  v as default
};
