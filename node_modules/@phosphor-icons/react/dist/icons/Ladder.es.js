...
var L = (l, e, t) => e in l ? r(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, h = (l, e) => {
  for (var t in e || (e = {}))
    A.call(e, t) && L(l, t, e[t]);
  if (m)
    for (var t of m(e))
      c.call(e, t) && L(l, t, e[t]);
  return l;
}, n = (l, e) => Z(l, H(e));
...
]), p = M((l, e) => /* @__PURE__ */ a.createElement(d, n(h({ ref: e }, l), { weights: o })));
p.displayName = "Ladder";
export {
  p as default
};
