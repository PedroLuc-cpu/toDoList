...
var V = (l, e, t) => e in l ? Z(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, r = (l, e) => {
  for (var t in e || (e = {}))
    L.call(e, t) && V(l, t, e[t]);
  if (H)
    for (var t of H(e))
      A.call(e, t) && V(l, t, e[t]);
  return l;
}, n = (l, e) => m(l, M(e));
...
]), p = h((l, e) => /* @__PURE__ */ a.createElement(c, n(r({ ref: e }, l), { weights: o })));
p.displayName = "ArrowsOut";
export {
  p as default
};
