...
var A = (t, a, H) => a in t ? r(t, a, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[a] = H, V = (t, a) => {
  for (var H in a || (a = {}))
    h.call(a, H) && A(t, H, a[H]);
  if (l)
    for (var H of l(a))
...
]), p = c((t, a) => /* @__PURE__ */ e.createElement(o, n(V({ ref: a }, t), { weights: d })));
