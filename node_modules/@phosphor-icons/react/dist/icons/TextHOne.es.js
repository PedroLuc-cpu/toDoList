...
var V = (t, e, l) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, r = (t, e) => {
  for (var l in e || (e = {}))
    E.call(e, l) && V(t, l, e[l]);
  if (n)
    for (var l of n(e))
...
]), c = p((t, e) => /* @__PURE__ */ a.createElement(H, m(r({ ref: e }, t), { weights: d })));
c.displayName = "TextHOne";
const u = c;
export {
  u as default
};
