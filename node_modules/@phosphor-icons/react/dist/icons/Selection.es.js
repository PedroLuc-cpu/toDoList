...
var H = (t, e, m) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, Z = (t, e) => {
  for (var m in e || (e = {}))
    r.call(e, m) && H(t, m, e[m]);
  if (V)
    for (var m of V(e))
...
]), p = v((t, e) => /* @__PURE__ */ a.createElement(c, l(Z({ ref: e }, t), { weights: o })));
p.displayName = "Selection";
export {
  p as default
};
