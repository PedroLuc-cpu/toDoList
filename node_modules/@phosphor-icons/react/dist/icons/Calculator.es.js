...
var A = (m, e, t) => e in m ? r(m, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : m[e] = t, l = (m, e) => {
  for (var t in e || (e = {}))
    h.call(e, t) && A(m, t, e[t]);
  if (Z)
    for (var t of Z(e))
...
]), H = o((m, e) => /* @__PURE__ */ a.createElement(E, n(l({ ref: e }, m), { weights: p })));
H.displayName = "Calculator";
const i = H;
export {
  i as default
};
