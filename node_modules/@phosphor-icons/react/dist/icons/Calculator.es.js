...
var A = (m, e, t) => e in m ? n(m, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : m[e] = t, l = (m, e) => {
  for (var t in e || (e = {}))
    c.call(e, t) && A(m, t, e[t]);
  if (Z)
    for (var t of Z(e))
...
]), E = M((m, e) => /* @__PURE__ */ a.createElement(o, H(l({ ref: e }, m), { weights: p })));
E.displayName = "Calculator";
export {
  E as default
};
