...
var m = (l, e, c) => e in l ? r(l, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : l[e] = c, Z = (l, e) => {
  for (var c in e || (e = {}))
    C.call(e, c) && m(l, c, e[c]);
  if (t)
    for (var c of t(e))
      L.call(e, c) && m(l, c, e[c]);
  return l;
}, n = (l, e) => A(l, M(e));
...
]), s = h((l, e) => /* @__PURE__ */ a.createElement(o, n(Z({ ref: e }, l), { weights: p })));
s.displayName = "Guitar";
export {
  s as default
};
