...
var c = (t, e, l) => e in t ? V(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, n = (t, e) => {
  for (var l in e || (e = {}))
    o.call(e, l) && c(t, l, e[l]);
  if (A)
    for (var l of A(e))
      p.call(e, l) && c(t, l, e[l]);
  return t;
}, m = (t, e) => Z(t, M(e));
...
]), r = E((t, e) => /* @__PURE__ */ a.createElement(v, m(n({ ref: e }, t), { weights: d })));
r.displayName = "FlowerTulip";
const h = r;
export {
  h as default
};
