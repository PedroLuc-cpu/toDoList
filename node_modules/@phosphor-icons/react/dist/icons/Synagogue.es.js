...
var A = (e, V, t) => V in e ? H(e, V, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[V] = t, l = (e, V) => {
  for (var t in V || (V = {}))
    r.call(V, t) && A(e, t, V[t]);
  if (v)
    for (var t of v(V))
      M.call(V, t) && A(e, t, V[t]);
  return e;
}, m = (e, V) => Z(e, h(V));
...
]), n = c((e, V) => /* @__PURE__ */ a.createElement(o, m(l({ ref: V }, e), { weights: g })));
n.displayName = "Synagogue";
const u = n;
export {
  u as default
};
