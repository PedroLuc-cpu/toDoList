...
var m = (t, e, n) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, r = (t, e) => {
  for (var n in e || (e = {}))
    o.call(e, n) && m(t, n, e[n]);
  if (l)
    for (var n of l(e))
      E.call(e, n) && m(t, n, e[n]);
  return t;
}, Z = (t, e) => h(t, M(e));
...
]), A = p((t, e) => /* @__PURE__ */ a.createElement(L, Z(r({ ref: e }, t), { weights: d })));
