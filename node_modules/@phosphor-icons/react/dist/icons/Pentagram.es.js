...
var L = (a, l, t) => l in a ? r(a, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[l] = t, Z = (a, l) => {
  for (var t in l || (l = {}))
    M.call(l, t) && L(a, t, l[t]);
  if (m)
    for (var t of m(l))
...
]), E = c((a, l) => /* @__PURE__ */ e.createElement(o, n(Z({ ref: l }, a), { weights: p })));
E.displayName = "Pentagram";
export {
  E as default
};
