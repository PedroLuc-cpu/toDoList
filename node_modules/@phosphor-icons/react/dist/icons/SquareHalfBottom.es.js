...
var l = (a, t, m) => t in a ? r(a, t, { enumerable: !0, configurable: !0, writable: !0, value: m }) : a[t] = m, Z = (a, t) => {
  for (var m in t || (t = {}))
    h.call(t, m) && l(a, m, t[m]);
  if (H)
    for (var m of H(t))
...
]), E = o((a, t) => /* @__PURE__ */ e.createElement(A, n(Z({ ref: t }, a), { weights: p })));
E.displayName = "SquareHalfBottom";
export {
  E as default
};
