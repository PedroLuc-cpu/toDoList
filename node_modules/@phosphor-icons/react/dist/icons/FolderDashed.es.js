...
var H = (A, e, t) => e in A ? n(A, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : A[e] = t, l = (A, e) => {
  for (var t in e || (e = {}))
    v.call(e, t) && H(A, t, e[t]);
  if (m)
    for (var t of m(e))
      c.call(e, t) && H(A, t, e[t]);
  return A;
}, Z = (A, e) => r(A, V(e));
...
]), h = d((A, e) => /* @__PURE__ */ a.createElement(o, Z(l({ ref: e }, A), { weights: M })));
h.displayName = "FolderDashed";
const g = h;
export {
  g as default
};
