...
var n = (a, l, t) => l in a ? M(a, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[l] = t, r = (a, l) => {
  for (var t in l || (l = {}))
    p.call(l, t) && n(a, t, l[t]);
  if (m)
    for (var t of m(l))
...
]), d = H((a, l) => /* @__PURE__ */ e.createElement(o, Z(r({ ref: l }, a), { weights: E })));
d.displayName = "EnvelopeOpen";
export {
  d as default
};
