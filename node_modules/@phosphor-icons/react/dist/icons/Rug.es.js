...
var m = (e, V, l) => V in e ? r(e, V, { enumerable: !0, configurable: !0, writable: !0, value: l }) : e[V] = l, H = (e, V) => {
  for (var l in V || (V = {}))
    c.call(V, l) && m(e, l, V[l]);
  if (t)
    for (var l of t(V))
...
]), M = o((e, V) => /* @__PURE__ */ a.createElement(p, n(H({ ref: V }, e), { weights: E })));
M.displayName = "Rug";
export {
  M as default
};
