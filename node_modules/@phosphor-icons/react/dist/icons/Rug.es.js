...
var m = (e, V, l) => V in e ? Z(e, V, { enumerable: !0, configurable: !0, writable: !0, value: l }) : e[V] = l, H = (e, V) => {
  for (var l in V || (V = {}))
    v.call(V, l) && m(e, l, V[l]);
  if (t)
    for (var l of t(V))
      o.call(V, l) && m(e, l, V[l]);
  return e;
}, n = (e, V) => h(e, c(V));
...
]), r = E((e, V) => /* @__PURE__ */ a.createElement(M, n(H({ ref: V }, e), { weights: p })));
r.displayName = "Rug";
const A = r;
export {
  A as default
