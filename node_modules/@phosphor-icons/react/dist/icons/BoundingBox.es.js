...
var t = (V, H, e) => H in V ? n(V, H, { enumerable: !0, configurable: !0, writable: !0, value: e }) : V[H] = e, v = (V, H) => {
  for (var e in H || (H = {}))
    r.call(H, e) && t(V, e, H[e]);
  if (h)
    for (var e of h(H))
      A.call(H, e) && t(V, e, H[e]);
  return V;
}, m = (V, H) => Z(V, l(H));
...
]), d = M((V, H) => /* @__PURE__ */ a.createElement(c, m(v({ ref: H }, V), { weights: o })));
