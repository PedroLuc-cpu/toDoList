...
var t = (V, H, e) => H in V ? Z(V, H, { enumerable: !0, configurable: !0, writable: !0, value: e }) : V[H] = e, v = (V, H) => {
  for (var e in H || (H = {}))
    r.call(H, e) && t(V, e, H[e]);
  if (h)
    for (var e of h(H))
      M.call(H, e) && t(V, e, H[e]);
  return V;
}, n = (V, H) => l(V, A(H));
...
]), m = c((V, H) => /* @__PURE__ */ a.createElement(o, n(v({ ref: H }, V), { weights: d })));
m.displayName = "BoundingBox";
const u = m;
export {
  u as default
};
