...
var V = (l, e, t) => e in l ? A(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, n = (l, e) => {
  for (var t in e || (e = {}))
    p.call(e, t) && V(l, t, e[t]);
  if (H)
    for (var t of H(e))
...
]), m = E((l, e) => /* @__PURE__ */ a.createElement(M, r(n({ ref: e }, l), { weights: h })));
m.displayName = "Swap";
const u = m;
export {
  u as default
