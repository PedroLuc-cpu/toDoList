...
var A = (t, e, c) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, Z = (t, e) => {
  for (var c in e || (e = {}))
    M.call(e, c) && A(t, c, e[c]);
  if (m)
    for (var c of m(e))
      H.call(e, c) && A(t, c, e[c]);
  return t;
}, n = (t, e) => r(t, h(e));
...
]), E = C((t, e) => /* @__PURE__ */ a.createElement(p, n(Z({ ref: e }, t), { weights: o })));
E.displayName = "Champagne";
export {
  E as default
};
