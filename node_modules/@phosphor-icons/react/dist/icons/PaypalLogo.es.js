...
var h = (l, e, A) => e in l ? n(l, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : l[e] = A, H = (l, e) => {
  for (var A in e || (e = {}))
    Z.call(e, A) && h(l, A, e[A]);
  if (t)
    for (var A of t(e))
...
]), d = M((l, e) => /* @__PURE__ */ a.createElement(p, m(H({ ref: e }, l), { weights: E })));
d.displayName = "PaypalLogo";
export {
  d as default
};
