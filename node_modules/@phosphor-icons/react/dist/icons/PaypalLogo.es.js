...
var h = (l, e, A) => e in l ? r(l, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : l[e] = A, H = (l, e) => {
  for (var A in e || (e = {}))
    o.call(e, A) && h(l, A, e[A]);
  if (t)
    for (var A of t(e))
      M.call(e, A) && h(l, A, e[A]);
  return l;
}, n = (l, e) => c(l, Z(e));
...
]), m = p((l, e) => /* @__PURE__ */ a.createElement(E, n(H({ ref: e }, l), { weights: L })));
m.displayName = "PaypalLogo";
const i = m;
export {
  i as default
};
