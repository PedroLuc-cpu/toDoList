...
var r = (e, l, t) => l in e ? Z(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, n = (e, l) => {
  for (var t in l || (l = {}))
    A.call(l, t) && r(e, t, l[t]);
  if (m)
    for (var t of m(l))
...
]), L = E((e, l) => /* @__PURE__ */ a.createElement(M, c(n({ ref: l }, e), { weights: d })));
L.displayName = "EyedropperSample";
const i = L;
export {
  i as default
};
