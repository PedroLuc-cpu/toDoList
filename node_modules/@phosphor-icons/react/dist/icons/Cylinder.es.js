...
var m = (c, t, a) => t in c ? s(c, t, { enumerable: !0, configurable: !0, writable: !0, value: a }) : c[t] = a, n = (c, t) => {
  for (var a in t || (t = {}))
    Z.call(t, a) && m(c, a, t[a]);
  if (l)
    for (var a of l(t))
      d.call(t, a) && m(c, a, t[a]);
  return c;
}, r = (c, t) => C(c, V(t));
...
]), i = o((c, t) => /* @__PURE__ */ e.createElement(p, r(n({ ref: t }, c), { weights: E })));
