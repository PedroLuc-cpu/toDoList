...
var n = (c, t, l) => t in c ? C(c, t, { enumerable: !0, configurable: !0, writable: !0, value: l }) : c[t] = l, m = (c, t) => {
  for (var l in t || (t = {}))
    d.call(t, l) && n(c, l, t[l]);
  if (a)
    for (var l of a(t))
      o.call(t, l) && n(c, l, t[l]);
  return c;
}, r = (c, t) => V(c, Z(t));
...
]), s = E((c, t) => /* @__PURE__ */ e.createElement(p, r(m({ ref: t }, c), { weights: i })));
s.displayName = "Cylinder";
const M = s;
export {
  M as default
};
