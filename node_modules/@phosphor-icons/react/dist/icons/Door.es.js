...
var m = (t, a, H) => a in t ? c(t, a, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[a] = H, n = (t, a) => {
  for (var H in a || (a = {}))
    Z.call(a, H) && m(t, H, a[H]);
  if (l)
    for (var H of l(a))
      p.call(a, H) && m(t, H, a[H]);
  return t;
}, r = (t, a) => V(t, o(a));
...
]), d = E((t, a) => /* @__PURE__ */ e.createElement(A, r(n({ ref: a }, t), { weights: M })));
d.displayName = "Door";
export {
  d as default
};
