...
var r = (t, e, A) => e in t ? M(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, l = (t, e) => {
  for (var A in e || (e = {}))
    o.call(e, A) && r(t, A, e[A]);
  if (Z)
    for (var A of Z(e))
      E.call(e, A) && r(t, A, e[A]);
  return t;
}, n = (t, e) => c(t, h(e));
...
]), m = p((t, e) => /* @__PURE__ */ a.createElement(s, n(l({ ref: e }, t), { weights: d })));
m.displayName = "UsersFour";
const i = m;
export {
  i as default
};
