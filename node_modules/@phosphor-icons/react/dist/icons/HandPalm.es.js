...
var n = (t, e, V) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, m = (t, e) => {
  for (var V in e || (e = {}))
    o.call(e, V) && n(t, V, e[V]);
  if (l)
    for (var V of l(e))
      E.call(e, V) && n(t, V, e[V]);
  return t;
}, r = (t, e) => c(t, d(e));
...
const h = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement("path", { d: "M216,104v48a88,88,0,0,1-176,0V64a16,16,0,0,1,32,0v56a8,8,0,0,0,16,0V32a16,16,0,0,1,32,0v80a8,8,0,0,0,16,0V48a16,16,0,0,1,32,0v80.67A48.08,48.08,0,0,0,128,176a8,8,0,0,0,16,0,32,32,0,0,1,32-32,8,8,0,0,0,8-8V104a16,16,0,0,1,32,0Z" }))
  ],
  [
    "light",
...
]), v = p((t, e) => /* @__PURE__ */ a.createElement(Z, r(m({ ref: e }, t), { weights: h })));
v.displayName = "HandPalm";
const M = v;
export {
  M as default
};
