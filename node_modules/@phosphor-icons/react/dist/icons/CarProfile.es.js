...
var A = (H, e, t) => e in H ? Z(H, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : H[e] = t, m = (H, e) => {
  for (var t in e || (e = {}))
    h.call(e, t) && A(H, t, e[t]);
  if (l)
    for (var t of l(e))
      o.call(e, t) && A(H, t, e[t]);
  return H;
}, r = (H, e) => M(H, c(e));
...
]), n = E((H, e) => /* @__PURE__ */ a.createElement(L, r(m({ ref: e }, H), { weights: p })));
n.displayName = "CarProfile";
const f = n;
export {
  f as default
};
