...
var m = (l, e, t) => e in l ? M(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, n = (l, e) => {
  for (var t in e || (e = {}))
    L.call(e, t) && m(l, t, e[t]);
  if (Z)
    for (var t of Z(e))
...
]), r = h((l, e) => /* @__PURE__ */ a.createElement(p, c(n({ ref: e }, l), { weights: V })));
r.displayName = "Confetti";
const g = r;
export {
  g as default
};
