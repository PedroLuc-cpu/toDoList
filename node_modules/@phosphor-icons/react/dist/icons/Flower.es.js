...
var A = (e, c, t) => c in e ? n(e, c, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[c] = t, Z = (e, c) => {
  for (var t in c || (c = {}))
    C.call(c, t) && A(e, t, c[t]);
  if (l)
    for (var t of l(c))
      o.call(c, t) && A(e, t, c[t]);
  return e;
}, m = (e, c) => r(e, M(c));
...
]), h = p((e, c) => /* @__PURE__ */ a.createElement(E, m(Z({ ref: c }, e), { weights: d })));
h.displayName = "Flower";
export {
  h as default
};
