...
var Z = (e, l, t) => l in e ? L(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, r = (e, l) => {
  for (var t in l || (l = {}))
    h.call(l, t) && Z(e, t, l[t]);
  if (m)
    for (var t of m(l))
      o.call(l, t) && Z(e, t, l[t]);
  return e;
}, n = (e, l) => M(e, c(l));
...
]), A = E((e, l) => /* @__PURE__ */ a.createElement(p, n(r({ ref: l }, e), { weights: d })));
A.displayName = "CursorClick";
const g = A;
export {
  g as default
};
