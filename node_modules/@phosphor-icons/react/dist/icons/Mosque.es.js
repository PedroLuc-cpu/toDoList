...
var c = (t, e, V) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, v = (t, e) => {
  for (var V in e || (e = {}))
    M.call(e, V) && c(t, V, e[V]);
  if (H)
    for (var V of H(e))
      h.call(e, V) && c(t, V, e[V]);
  return t;
}, m = (t, e) => r(t, Z(e));
...
]), l = C((t, e) => /* @__PURE__ */ a.createElement(o, m(v({ ref: e }, t), { weights: A })));
l.displayName = "Mosque";
const u = l;
export {
  u as default
};
