...
var v = (t, e, V) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, c = (t, e) => {
  for (var V in e || (e = {}))
    Z.call(e, V) && v(t, V, e[V]);
  if (H)
    for (var V of H(e))
      M.call(e, V) && v(t, V, e[V]);
  return t;
}, m = (t, e) => n(t, r(e));
...
]), p = h((t, e) => /* @__PURE__ */ a.createElement(C, m(c({ ref: e }, t), { weights: o })));
p.displayName = "Mosque";
export {
  p as default
};
