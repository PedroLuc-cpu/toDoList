...
var V = (h, e, t) => e in h ? v(h, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : h[e] = t, l = (h, e) => {
  for (var t in e || (e = {}))
    c.call(e, t) && V(h, t, e[t]);
  if (H)
    for (var t of H(e))
      M.call(e, t) && V(h, t, e[t]);
  return h;
}, n = (h, e) => A(h, m(e));
...
]), r = Z((h, e) => /* @__PURE__ */ a.createElement(i, n(l({ ref: e }, h), { weights: o })));
r.displayName = "FileArchive";
const g = r;
export {
  g as default
};
