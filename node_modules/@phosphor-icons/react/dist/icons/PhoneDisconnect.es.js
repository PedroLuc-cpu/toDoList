...
var c = (l, e, t) => e in l ? o(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, m = (l, e) => {
  for (var t in e || (e = {}))
    A.call(e, t) && c(l, t, e[t]);
  if (n)
    for (var t of n(e))
...
]), h = E((l, e) => /* @__PURE__ */ a.createElement(M, r(m({ ref: e }, l), { weights: p })));
h.displayName = "PhoneDisconnect";
const i = h;
export {
  i as default
};
