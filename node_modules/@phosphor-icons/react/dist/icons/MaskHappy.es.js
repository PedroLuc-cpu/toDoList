...
var s = (t, a, c) => a in t ? n(t, a, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[a] = c, A = (t, a) => {
  for (var c in a || (a = {}))
    Z.call(a, c) && s(t, c, a[c]);
  if (m)
    for (var c of m(a))
      p.call(a, c) && s(t, c, a[c]);
  return t;
}, l = (t, a) => C(t, r(a));
