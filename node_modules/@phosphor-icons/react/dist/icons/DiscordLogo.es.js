...
var L = (e, l, t) => l in e ? n(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, m = (e, l) => {
  for (var t in l || (l = {}))
    o.call(l, t) && L(e, t, l[t]);
  if (A)
    for (var t of A(l))
      s.call(l, t) && L(e, t, l[t]);
  return e;
}, c = (e, l) => r(e, Z(l));
...
]), h = d((e, l) => /* @__PURE__ */ a.createElement(p, c(m({ ref: l }, e), { weights: E })));
h.displayName = "DiscordLogo";
export {
  h as default
};
