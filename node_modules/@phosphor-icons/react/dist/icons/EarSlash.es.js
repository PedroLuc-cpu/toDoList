...
var c = (A, e, t) => e in A ? r(A, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : A[e] = t, m = (A, e) => {
  for (var t in e || (e = {}))
    M.call(e, t) && c(A, t, e[t]);
  if (l)
    for (var t of l(e))
      E.call(e, t) && c(A, t, e[t]);
  return A;
}, n = (A, e) => Z(A, L(e));
...
]), d = C((A, e) => /* @__PURE__ */ a.createElement(o, n(m({ ref: e }, A), { weights: p })));
