...
var n = (t, e, m) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, l = (t, e) => {
  for (var m in e || (e = {}))
    s.call(e, m) && n(t, m, e[m]);
  if (V)
    for (var m of V(e))
...
]), c = d((t, e) => /* @__PURE__ */ a.createElement(o, v(l({ ref: e }, t), { weights: p })));
c.displayName = "HandEye";
const g = c;
export {
  g as default
};
