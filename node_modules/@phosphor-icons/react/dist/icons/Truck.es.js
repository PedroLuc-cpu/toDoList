...
var m = (H, e, t) => e in H ? V(H, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : H[e] = t, Z = (H, e) => {
  for (var t in e || (e = {}))
    h.call(e, t) && m(H, t, e[t]);
  if (l)
    for (var t of l(e))
      M.call(e, t) && m(H, t, e[t]);
  return H;
}, A = (H, e) => n(H, r(e));
...
]), E = c((H, e) => /* @__PURE__ */ a.createElement(o, A(Z({ ref: e }, H), { weights: p })));
E.displayName = "Truck";
export {
  E as default
};
