...
var h = (V, e, t) => e in V ? n(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, H = (V, e) => {
  for (var t in e || (e = {}))
    Z.call(e, t) && h(V, t, e[t]);
  if (l)
    for (var t of l(e))
...
]), o = A((V, e) => /* @__PURE__ */ a.createElement(L, m(H({ ref: e }, V), { weights: M })));
o.displayName = "Church";
export {
  o as default
};
