...
var r = (t, e, V) => e in t ? m(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, n = (t, e) => {
  for (var V in e || (e = {}))
    c.call(e, V) && r(t, V, e[V]);
  if (l)
    for (var V of l(e))
      h.call(e, V) && r(t, V, e[V]);
  return t;
}, A = (t, e) => Z(t, M(e));
...
]), H = i((t, e) => /* @__PURE__ */ a.createElement(o, A(n({ ref: e }, t), { weights: E })));
H.displayName = "Circuitry";
const L = H;
export {
  L as default
};
