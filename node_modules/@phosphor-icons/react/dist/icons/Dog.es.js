...
var m = (e, l, t) => l in e ? A(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, V = (e, l) => {
  for (var t in l || (l = {}))
    r.call(l, t) && m(e, t, l[t]);
  if (L)
    for (var t of L(l))
...
]), E = c((e, l) => /* @__PURE__ */ a.createElement(o, Z(V({ ref: l }, e), { weights: p })));
E.displayName = "Dog";
export {
  E as default
};
