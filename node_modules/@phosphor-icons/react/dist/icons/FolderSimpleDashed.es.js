...
var A = (t, e, m) => e in t ? V(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, l = (t, e) => {
  for (var m in e || (e = {}))
    v.call(e, m) && A(t, m, e[m]);
  if (H)
    for (var m of H(e))
...
]), n = M((t, e) => /* @__PURE__ */ a.createElement(d, Z(l({ ref: e }, t), { weights: o })));
n.displayName = "FolderSimpleDashed";
const s = n;
export {
  s as default
};
