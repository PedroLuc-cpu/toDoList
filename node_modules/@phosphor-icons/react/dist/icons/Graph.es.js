...
var m = (l, e, A) => e in l ? c(l, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : l[e] = A, Z = (l, e) => {
  for (var A in e || (e = {}))
    L.call(e, A) && m(l, A, e[A]);
  if (t)
    for (var A of t(e))
...
]), r = E((l, e) => /* @__PURE__ */ a.createElement(h, n(Z({ ref: e }, l), { weights: d })));
r.displayName = "Graph";
const s = r;
export {
  s as default
