...
var m = (t, e, c) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, C = (t, e) => {
  for (var c in e || (e = {}))
    Z.call(e, c) && m(t, c, e[c]);
  if (s)
    for (var c of s(e))
...
]), v = d((t, e) => /* @__PURE__ */ a.createElement(o, A(C({ ref: e }, t), { weights: p })));
v.displayName = "MaskSad";
export {
  v as default
};
