...
var V = (s, a, e) => a in s ? n(s, a, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[a] = e, m = (s, a) => {
  for (var e in a || (a = {}))
    h.call(a, e) && V(s, e, a[e]);
  if (t)
    for (var e of t(a))
      C.call(a, e) && V(s, e, a[e]);
  return s;
}, l = (s, a) => Z(s, r(a));
...
]), p = M((s, a) => /* @__PURE__ */ c.createElement(o, l(m({ ref: a }, s), { weights: A })));
