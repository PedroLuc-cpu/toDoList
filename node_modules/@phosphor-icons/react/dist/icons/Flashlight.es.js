...
var n = (V, e, t) => e in V ? Z(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, m = (V, e) => {
  for (var t in e || (e = {}))
    c.call(e, t) && n(V, t, e[t]);
  if (l)
    for (var t of l(e))
      A.call(e, t) && n(V, t, e[t]);
  return V;
}, r = (V, e) => h(V, M(e));
...
]), H = o((V, e) => /* @__PURE__ */ a.createElement(E, r(m({ ref: e }, V), { weights: p })));
H.displayName = "Flashlight";
const s = H;
export {
  s as default
};
