...
var n = (V, e, t) => e in V ? H(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, m = (V, e) => {
  for (var t in e || (e = {}))
    h.call(e, t) && n(V, t, e[t]);
  if (l)
    for (var t of l(e))
...
]), E = A((V, e) => /* @__PURE__ */ a.createElement(o, r(m({ ref: e }, V), { weights: p })));
E.displayName = "Flashlight";
export {
  E as default
};
