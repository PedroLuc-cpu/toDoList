...
var n = (t, e, c) => e in t ? H(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, r = (t, e) => {
  for (var c in e || (e = {}))
    C.call(e, c) && n(t, c, e[c]);
  if (l)
    for (var c of l(e))
      E.call(e, c) && n(t, c, e[c]);
  return t;
}, A = (t, e) => h(t, o(e));
...
]), m = p((t, e) => /* @__PURE__ */ a.createElement(M, A(r({ ref: e }, t), { weights: d })));
m.displayName = "Heartbeat";
const u = m;
export {
  u as default
};
