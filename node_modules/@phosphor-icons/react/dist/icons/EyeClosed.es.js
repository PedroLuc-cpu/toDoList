...
var A = (l, e, t) => e in l ? c(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, r = (l, e) => {
  for (var t in e || (e = {}))
    E.call(e, t) && A(l, t, e[t]);
  if (n)
    for (var t of n(e))
      s.call(e, t) && A(l, t, e[t]);
  return l;
}, m = (l, e) => L(l, o(e));
...
]), g = d((l, e) => /* @__PURE__ */ a.createElement(p, m(r({ ref: e }, l), { weights: h })));
g.displayName = "EyeClosed";
export {
  g as default
};
