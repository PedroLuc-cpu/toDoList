...
var H = (V, e, t) => e in V ? r(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, n = (V, e) => {
  for (var t in e || (e = {}))
    M.call(e, t) && H(V, t, e[t]);
  if (l)
    for (var t of l(e))
...
]), A = v((V, e) => /* @__PURE__ */ a.createElement(d, m(n({ ref: e }, V), { weights: o })));
