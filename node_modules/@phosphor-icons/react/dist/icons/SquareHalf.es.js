...
var h = (t, a, m) => a in t ? Z(t, a, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[a] = m, V = (t, a) => {
  for (var m in a || (a = {}))
    A.call(a, m) && h(t, m, a[m]);
  if (H)
    for (var m of H(a))
      M.call(a, m) && h(t, m, a[m]);
  return t;
}, l = (t, a) => r(t, c(a));
...
]), n = v((t, a) => /* @__PURE__ */ e.createElement(o, l(V({ ref: a }, t), { weights: E })));
