...
var n = (t, e, V) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, H = (t, e) => {
  for (var V in e || (e = {}))
    Z.call(e, V) && n(t, V, e[V]);
  if (m)
    for (var V of m(e))
...
const o = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement("path", { d: "M200,40H160a16,16,0,0,0-16,16v88a16,16,0,0,1-32,0V56A16,16,0,0,0,96,40H56A16,16,0,0,0,40,56v88a88,88,0,0,0,88,88h.67c48.15-.36,87.33-40.29,87.33-89V56A16,16,0,0,0,200,40Zm0,16V96H160V56ZM96,56V96H56V56Z" }))
  ],
  [
    "light",
...
]), r = M((t, e) => /* @__PURE__ */ a.createElement(g, l(H({ ref: e }, t), { weights: o })));
r.displayName = "MagnetStraight";
const i = r;
export {
  i as default
};
