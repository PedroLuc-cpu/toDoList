...
var l = (t, e, V) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, m = (t, e) => {
  for (var V in e || (e = {}))
    Z.call(e, V) && l(t, V, e[V]);
  if (H)
    for (var V of H(e))
      p.call(e, V) && l(t, V, e[V]);
  return t;
}, n = (t, e) => A(t, c(e));
...
]), r = o((t, e) => /* @__PURE__ */ a.createElement(E, n(m({ ref: e }, t), { weights: M })));
r.displayName = "GasPump";
const g = r;
export {
  g as default
};
