...
var m = (t, e, H) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, n = (t, e) => {
  for (var H in e || (e = {}))
    M.call(e, H) && m(t, H, e[H]);
  if (l)
    for (var H of l(e))
      p.call(e, H) && m(t, H, e[H]);
  return t;
}, r = (t, e) => Z(t, c(e));
...
]), A = o((t, e) => /* @__PURE__ */ a.createElement(E, r(n({ ref: e }, t), { weights: d })));
A.displayName = "Stamp";
const u = A;
export {
  u as default
