...
var Z = (t, e, V) => e in t ? H(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, l = (t, e) => {
  for (var V in e || (e = {}))
    o.call(e, V) && Z(t, V, e[V]);
  if (m)
    for (var V of m(e))
      h.call(e, V) && Z(t, V, e[V]);
  return t;
}, n = (t, e) => r(t, c(e));
...
]), A = E((t, e) => /* @__PURE__ */ a.createElement(p, n(l({ ref: e }, t), { weights: v })));
A.displayName = "Coffee";
const g = A;
export {
  g as default
};
