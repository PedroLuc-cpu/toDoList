...
var m = (e, l, t) => l in e ? A(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, L = (e, l) => {
  for (var t in l || (l = {}))
    d.call(l, t) && m(e, t, l[t]);
  if (n)
    for (var t of n(l))
      o.call(l, t) && m(e, t, l[t]);
  return e;
}, r = (e, l) => c(e, M(l));
...
]), Z = E((e, l) => /* @__PURE__ */ a.createElement(p, r(L({ ref: l }, e), { weights: g })));
Z.displayName = "HandsPraying";
const u = Z;
export {
  u as default
};
