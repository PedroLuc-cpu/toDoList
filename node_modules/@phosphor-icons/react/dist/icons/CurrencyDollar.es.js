...
var l = (h, e, t) => e in h ? V(h, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : h[e] = t, r = (h, e) => {
  for (var t in e || (e = {}))
    v.call(e, t) && l(h, t, e[t]);
  if (m)
    for (var t of m(e))
      Z.call(e, t) && l(h, t, e[t]);
  return h;
}, n = (h, e) => H(h, c(e));
...
]), d = o((h, e) => /* @__PURE__ */ a.createElement(p, n(r({ ref: e }, h), { weights: E })));
d.displayName = "CurrencyDollar";
export {
  d as default
};
