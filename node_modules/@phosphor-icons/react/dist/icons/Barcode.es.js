...
var m = (V, e, t) => e in V ? l(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, H = (V, e) => {
  for (var t in e || (e = {}))
    v.call(e, t) && m(V, t, e[t]);
  if (Z)
    for (var t of Z(e))
...
]), d = h((V, e) => /* @__PURE__ */ a.createElement(c, A(H({ ref: e }, V), { weights: o })));
d.displayName = "Barcode";
export {
  d as default
};
