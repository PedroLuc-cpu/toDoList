...
var m = (V, e, t) => e in V ? n(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, H = (V, e) => {
  for (var t in e || (e = {}))
    M.call(e, t) && m(V, t, e[t]);
  if (Z)
    for (var t of Z(e))
      c.call(e, t) && m(V, t, e[t]);
  return V;
}, A = (V, e) => r(V, v(e));
...
]), l = h((V, e) => /* @__PURE__ */ a.createElement(o, A(H({ ref: e }, V), { weights: d })));
l.displayName = "Barcode";
const u = l;
export {
  u as default
};
