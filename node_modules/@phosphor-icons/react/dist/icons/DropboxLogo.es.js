...
var m = (e, l, L) => l in e ? o(e, l, { enumerable: !0, configurable: !0, writable: !0, value: L }) : e[l] = L, Z = (e, l) => {
  for (var L in l || (l = {}))
    p.call(l, L) && m(e, L, l[L]);
  if (t)
    for (var L of t(l))
      E.call(l, L) && m(e, L, l[L]);
  return e;
}, n = (e, l) => c(e, M(l));
...
]), r = d((e, l) => /* @__PURE__ */ a.createElement(g, n(Z({ ref: l }, e), { weights: h })));
r.displayName = "DropboxLogo";
const s = r;
export {
  s as default
};
