...
var m = (e, l, L) => l in e ? r(e, l, { enumerable: !0, configurable: !0, writable: !0, value: L }) : e[l] = L, Z = (e, l) => {
  for (var L in l || (l = {}))
    M.call(l, L) && m(e, L, l[L]);
  if (t)
    for (var L of t(l))
...
]), h = E((e, l) => /* @__PURE__ */ a.createElement(d, n(Z({ ref: l }, e), { weights: g })));
