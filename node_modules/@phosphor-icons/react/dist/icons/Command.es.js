...
var h = (t, e, H) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, V = (t, e) => {
  for (var H in e || (e = {}))
    c.call(e, H) && h(t, H, e[H]);
  if (m)
    for (var H of m(e))
      v.call(e, H) && h(t, H, e[H]);
  return t;
}, Z = (t, e) => r(t, M(e));
...
]), n = A((t, e) => /* @__PURE__ */ a.createElement(o, Z(V({ ref: e }, t), { weights: d })));
n.displayName = "Command";
const u = n;
export {
  u as default
};
