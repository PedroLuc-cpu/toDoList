...
var H = (m, e, h) => e in m ? n(m, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : m[e] = h, Z = (m, e) => {
  for (var h in e || (e = {}))
    o.call(e, h) && H(m, h, e[h]);
  if (t)
    for (var h of t(e))
      p.call(e, h) && H(m, h, e[h]);
  return m;
}, l = (m, e) => r(m, c(e));
...
]), A = v((m, e) => /* @__PURE__ */ a.createElement(E, l(Z({ ref: e }, m), { weights: M })));
A.displayName = "TextColumns";
export {
  A as default
};
