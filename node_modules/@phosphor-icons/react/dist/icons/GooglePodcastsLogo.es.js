...
var Z = (V, e, m) => e in V ? v(V, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : V[e] = m, A = (V, e) => {
  for (var m in e || (e = {}))
    o.call(e, m) && Z(V, m, e[m]);
  if (t)
    for (var m of t(e))
...
]), E = c((V, e) => /* @__PURE__ */ a.createElement(d, l(A({ ref: e }, V), { weights: p })));
E.displayName = "GooglePodcastsLogo";
export {
  E as default
};
