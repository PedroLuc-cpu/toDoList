...
var n = (t, e, r) => e in t ? V(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, H = (t, e) => {
  for (var r in e || (e = {}))
    o.call(e, r) && n(t, r, e[r]);
  if (l)
    for (var r of l(e))
      p.call(e, r) && n(t, r, e[r]);
  return t;
}, m = (t, e) => h(t, c(e));
...
]), d = E((t, e) => /* @__PURE__ */ a.createElement(Z, m(H({ ref: e }, t), { weights: M })));
d.displayName = "BracketsSquare";
export {
  d as default
};
