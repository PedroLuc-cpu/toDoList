...
var Z = (A, e, t) => e in A ? c(A, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : A[e] = t, l = (A, e) => {
  for (var t in e || (e = {}))
    d.call(e, t) && Z(A, t, e[t]);
  if (m)
    for (var t of m(e))
      h.call(e, t) && Z(A, t, e[t]);
  return A;
}, n = (A, e) => o(A, M(e));
...
]), r = E((A, e) => /* @__PURE__ */ a.createElement(p, n(l({ ref: e }, A), { weights: u })));
