...
var l = (t, e, V) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, n = (t, e) => {
  for (var V in e || (e = {}))
    A.call(e, V) && l(t, V, e[V]);
  if (H)
    for (var V of H(e))
      M.call(e, V) && l(t, V, e[V]);
  return t;
}, m = (t, e) => h(t, Z(e));
...
const p = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a.createElement("path", { d: "M216,64H176a48,48,0,0,0-96,0H40A16,16,0,0,0,24,80V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V80A16,16,0,0,0,216,64ZM128,32a32,32,0,0,1,32,32H96A32,32,0,0,1,128,32Zm88,168H40V80H80V96a8,8,0,0,0,16,0V80h64V96a8,8,0,0,0,16,0V80h40Z" }))
  ],
  [
    "fill",
...
]), r = o((t, e) => /* @__PURE__ */ a.createElement(E, m(n({ ref: e }, t), { weights: p })));
r.displayName = "Bag";
const i = r;
export {
  i as default
