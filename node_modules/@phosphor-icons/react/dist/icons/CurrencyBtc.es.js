...
var H = (t, e, V) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, n = (t, e) => {
  for (var V in e || (e = {}))
    Z.call(e, V) && H(t, V, e[V]);
  if (h)
    for (var V of h(e))
      v.call(e, V) && H(t, V, e[V]);
  return t;
}, r = (t, e) => m(t, c(e));
...
]), A = M((t, e) => /* @__PURE__ */ a.createElement(o, r(n({ ref: e }, t), { weights: p })));
A.displayName = "CurrencyBtc";
export {
  A as default
};
