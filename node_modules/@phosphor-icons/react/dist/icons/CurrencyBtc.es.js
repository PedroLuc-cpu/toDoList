...
var n = (t, e, V) => e in t ? m(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, H = (t, e) => {
  for (var V in e || (e = {}))
    v.call(e, V) && n(t, V, e[V]);
  if (h)
    for (var V of h(e))
      M.call(e, V) && n(t, V, e[V]);
  return t;
}, r = (t, e) => c(t, Z(e));
...
const E = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a.createElement("path", { d: "M170.48,115.7A44,44,0,0,0,144,40.19V24a8,8,0,0,0-16,0V40H112V24a8,8,0,0,0-16,0V40H64a8,8,0,0,0,0,16h8V192H64a8,8,0,0,0,0,16H96v16a8,8,0,0,0,16,0V208h16v16a8,8,0,0,0,16,0V208h8a48,48,0,0,0,18.48-92.3ZM88,56h52a28,28,0,0,1,0,56H88Zm64,136H88V128h64a32,32,0,0,1,0,64Z" }))
  ],
  [
    "fill",
...
]), l = o((t, e) => /* @__PURE__ */ a.createElement(A, r(H({ ref: e }, t), { weights: E })));
