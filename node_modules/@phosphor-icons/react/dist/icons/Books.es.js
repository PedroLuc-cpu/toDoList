...
var Z = (l, e, m) => e in l ? A(l, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : l[e] = m, h = (l, e) => {
  for (var m in e || (e = {}))
    L.call(e, m) && Z(l, m, e[m]);
  if (t)
    for (var m of t(e))
...
]), p = H((l, e) => /* @__PURE__ */ a.createElement(c, n(h({ ref: e }, l), { weights: o })));
p.displayName = "Books";
export {
  p as default
};
