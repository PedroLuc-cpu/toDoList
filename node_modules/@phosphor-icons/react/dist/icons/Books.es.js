...
var Z = (l, e, m) => e in l ? V(l, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : l[e] = m, h = (l, e) => {
  for (var m in e || (e = {}))
    M.call(e, m) && Z(l, m, e[m]);
  if (t)
    for (var m of t(e))
      c.call(e, m) && Z(l, m, e[m]);
  return l;
}, n = (l, e) => r(l, L(e));
...
]), A = H((l, e) => /* @__PURE__ */ a.createElement(o, n(h({ ref: e }, l), { weights: E })));
A.displayName = "Books";
const g = A;
export {
  g as default
