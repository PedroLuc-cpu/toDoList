...
var n = (t, e, v) => e in t ? V(t, e, { enumerable: !0, configurable: !0, writable: !0, value: v }) : t[e] = v, l = (t, e) => {
  for (var v in e || (e = {}))
    A.call(e, v) && n(t, v, e[v]);
  if (m)
    for (var v of m(e))
...
]), d = p((t, e) => /* @__PURE__ */ a.createElement(E, r(l({ ref: e }, t), { weights: M })));
d.displayName = "Rainbow";
export {
  d as default
};
