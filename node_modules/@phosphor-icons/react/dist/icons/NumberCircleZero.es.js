...
var r = (m, t, c) => t in m ? Z(m, t, { enumerable: !0, configurable: !0, writable: !0, value: c }) : m[t] = c, l = (m, t) => {
  for (var c in t || (t = {}))
    p.call(t, c) && r(m, c, t[c]);
  if (a)
    for (var c of a(t))
      d.call(t, c) && r(m, c, t[c]);
  return m;
}, n = (m, t) => o(m, E(t));
...
]), s = u((m, t) => /* @__PURE__ */ e.createElement(A, n(l({ ref: t }, m), { weights: C })));
s.displayName = "NumberCircleZero";
const M = s;
export {
  M as default
};
