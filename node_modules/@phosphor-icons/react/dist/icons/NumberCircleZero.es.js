...
var r = (m, t, a) => t in m ? s(m, t, { enumerable: !0, configurable: !0, writable: !0, value: a }) : m[t] = a, l = (m, t) => {
  for (var a in t || (t = {}))
    p.call(t, a) && r(m, a, t[a]);
  if (c)
    for (var a of c(t))
      E.call(t, a) && r(m, a, t[a]);
  return m;
}, n = (m, t) => Z(m, o(t));
...
]), u = d((m, t) => /* @__PURE__ */ e.createElement(A, n(l({ ref: t }, m), { weights: i })));
