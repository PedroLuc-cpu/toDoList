...
var H = (m, e, h) => e in m ? v(m, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : m[e] = h, V = (m, e) => {
  for (var h in e || (e = {}))
    l.call(e, h) && H(m, h, e[h]);
  if (t)
    for (var h of t(e))
...
]), E = c((m, e) => /* @__PURE__ */ a.createElement(o, Z(V({ ref: e }, m), { weights: p })));
E.displayName = "SquaresFour";
export {
  E as default
};
