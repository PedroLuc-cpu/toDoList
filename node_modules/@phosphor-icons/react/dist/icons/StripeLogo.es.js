...
var n = (t, a, c) => a in t ? V(t, a, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[a] = c, r = (t, a) => {
  for (var c in a || (a = {}))
    p.call(a, c) && n(t, c, a[c]);
  if (l)
    for (var c of l(a))
      s.call(a, c) && n(t, c, a[c]);
  return t;
}, m = (t, a) => o(t, Z(a));
