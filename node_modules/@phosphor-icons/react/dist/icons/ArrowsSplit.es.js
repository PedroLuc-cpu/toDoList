...
var n = (e, l, t) => l in e ? L(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, m = (e, l) => {
  for (var t in l || (l = {}))
    A.call(l, t) && n(e, t, l[t]);
  if (r)
    for (var t of r(l))
...
]), c = h((e, l) => /* @__PURE__ */ a.createElement(d, V(m({ ref: l }, e), { weights: i })));
c.displayName = "ArrowsSplit";
const g = c;
export {
  g as default
};
