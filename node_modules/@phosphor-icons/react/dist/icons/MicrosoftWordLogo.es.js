...
var V = (H, e, l) => e in H ? n(H, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : H[e] = l, m = (H, e) => {
  for (var l in e || (e = {}))
    M.call(e, l) && V(H, l, e[l]);
  if (t)
    for (var l of t(e))
      h.call(e, l) && V(H, l, e[l]);
  return H;
}, Z = (H, e) => v(H, o(e));
...
]), r = c((H, e) => /* @__PURE__ */ a.createElement(A, Z(m({ ref: e }, H), { weights: d })));
r.displayName = "MicrosoftWordLogo";
const s = r;
export {
  s as default
};
