...
var V = (l, e, t) => e in l ? r(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, m = (l, e) => {
  for (var t in e || (e = {}))
    M.call(e, t) && V(l, t, e[t]);
  if (H)
    for (var t of H(e))
...
]), p = h((l, e) => /* @__PURE__ */ a.createElement(L, n(m({ ref: e }, l), { weights: o })));
p.displayName = "Images";
export {
  p as default
};
