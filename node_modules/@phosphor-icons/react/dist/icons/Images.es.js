...
var V = (l, e, t) => e in l ? Z(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, m = (l, e) => {
  for (var t in e || (e = {}))
    c.call(e, t) && V(l, t, e[t]);
  if (H)
    for (var t of H(e))
      h.call(e, t) && V(l, t, e[t]);
  return l;
}, n = (l, e) => A(l, M(e));
...
]), r = L((l, e) => /* @__PURE__ */ a.createElement(o, n(m({ ref: e }, l), { weights: E })));
r.displayName = "Images";
const g = r;
export {
  g as default
};
