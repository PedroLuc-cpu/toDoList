...
var Z = (m, e, t) => e in m ? H(m, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : m[e] = t, l = (m, e) => {
  for (var t in e || (e = {}))
    i.call(e, t) && Z(m, t, e[t]);
  if (A)
    for (var t of A(e))
      o.call(e, t) && Z(m, t, e[t]);
  return m;
}, n = (m, e) => c(m, V(e));
...
]), r = E((m, e) => /* @__PURE__ */ a.createElement(M, n(l({ ref: e }, m), { weights: p })));
r.displayName = "DiceFive";
const u = r;
export {
  u as default
};
