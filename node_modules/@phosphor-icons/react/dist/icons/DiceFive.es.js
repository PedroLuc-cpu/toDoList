...
var Z = (m, e, t) => e in m ? r(m, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : m[e] = t, l = (m, e) => {
  for (var t in e || (e = {}))
    V.call(e, t) && Z(m, t, e[t]);
  if (A)
    for (var t of A(e))
...
]), i = p((m, e) => /* @__PURE__ */ a.createElement(E, n(l({ ref: e }, m), { weights: M })));
