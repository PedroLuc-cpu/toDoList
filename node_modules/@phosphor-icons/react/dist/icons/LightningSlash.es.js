...
var L = (e, l, t) => l in e ? Z(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, m = (e, l) => {
  for (var t in l || (l = {}))
    M.call(l, t) && L(e, t, l[t]);
  if (n)
    for (var t of n(l))
      i.call(l, t) && L(e, t, l[t]);
  return e;
}, r = (e, l) => h(e, g(l));
...
]), c = o((e, l) => /* @__PURE__ */ a.createElement(E, r(m({ ref: l }, e), { weights: p })));
c.displayName = "LightningSlash";
const u = c;
export {
  u as default
};
