...
var m = (t, e, A) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, n = (t, e) => {
  for (var A in e || (e = {}))
    c.call(e, A) && m(t, A, e[A]);
  if (l)
    for (var A of l(e))
...
]), r = o((t, e) => /* @__PURE__ */ a.createElement(E, H(n({ ref: e }, t), { weights: M })));
r.displayName = "ShoppingCart";
const u = r;
export {
  u as default
};
