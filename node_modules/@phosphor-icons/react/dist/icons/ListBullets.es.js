...
var H = (t, e, m) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, Z = (t, e) => {
  for (var m in e || (e = {}))
    E.call(e, m) && H(t, m, e[m]);
  if (l)
    for (var m of l(e))
      M.call(e, m) && H(t, m, e[m]);
  return t;
}, n = (t, e) => c(t, o(e));
...
]), r = p((t, e) => /* @__PURE__ */ a.createElement(s, n(Z({ ref: e }, t), { weights: d })));
r.displayName = "ListBullets";
const g = r;
export {
  g as default
};
