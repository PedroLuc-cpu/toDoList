...
var m = (t, e, c) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, h = (t, e) => {
  for (var c in e || (e = {}))
    H.call(e, c) && m(t, c, e[c]);
  if (l)
    for (var c of l(e))
      V.call(e, c) && m(t, c, e[c]);
  return t;
}, A = (t, e) => Z(t, r(e));
...
]), p = M((t, e) => /* @__PURE__ */ a.createElement(v, A(h({ ref: e }, t), { weights: o })));
p.displayName = "FileRs";
export {
  p as default
};
