...
var h = (t, e, H) => e in t ? m(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, l = (t, e) => {
  for (var H in e || (e = {}))
    A.call(e, H) && h(t, H, e[H]);
  if (V)
    for (var H of V(e))
      d.call(e, H) && h(t, H, e[H]);
  return t;
}, n = (t, e) => c(t, v(e));
...
const E = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    /* @__PURE__ */ a.createElement(a.Fragment, null, /* @__PURE__ */ a.createElement("path", { d: "M232,104v48a16,16,0,0,1-16,16H168v48a16,16,0,0,1-16,16H104a16,16,0,0,1-16-16V168H40a16,16,0,0,1-16-16V104A16,16,0,0,1,40,88H88V40a16,16,0,0,1,16-16h48a16,16,0,0,1,16,16V88h48A16,16,0,0,1,232,104Z" }))
  ],
  [
    "light",
...
]), r = i((t, e) => /* @__PURE__ */ a.createElement(o, n(l({ ref: e }, t), { weights: E })));
r.displayName = "FirstAid";
const g = r;
export {
  g as default
};
