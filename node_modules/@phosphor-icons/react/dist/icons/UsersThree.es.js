...
var l = (t, e, A) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: A }) : t[e] = A, n = (t, e) => {
  for (var A in e || (e = {}))
    E.call(e, A) && l(t, A, e[A]);
  if (r)
    for (var A of r(e))
      h.call(e, A) && l(t, A, e[A]);
  return t;
}, m = (t, e) => M(t, o(e));
...
]), Z = p((t, e) => /* @__PURE__ */ a.createElement(s, m(n({ ref: e }, t), { weights: d })));
Z.displayName = "UsersThree";
const f = Z;
export {
  f as default
};
