...
var h = (e, H, V) => H in e ? n(e, H, { enumerable: !0, configurable: !0, writable: !0, value: V }) : e[H] = V, m = (e, H) => {
  for (var V in H || (H = {}))
    A.call(H, V) && h(e, V, H[V]);
  if (t)
    for (var V of t(H))
      c.call(H, V) && h(e, V, H[V]);
  return e;
}, v = (e, H) => r(e, Z(H));
...
]), l = o((e, H) => /* @__PURE__ */ a.createElement(E, v(m({ ref: H }, e), { weights: M })));
l.displayName = "Barbell";
const s = l;
export {
  s as default
};
