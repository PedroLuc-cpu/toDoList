...
var h = (e, H, V) => H in e ? l(e, H, { enumerable: !0, configurable: !0, writable: !0, value: V }) : e[H] = V, m = (e, H) => {
  for (var V in H || (H = {}))
    Z.call(H, V) && h(e, V, H[V]);
  if (t)
    for (var V of t(H))
...
]), E = c((e, H) => /* @__PURE__ */ a.createElement(o, v(m({ ref: H }, e), { weights: p })));
E.displayName = "Barbell";
export {
  E as default
};
