...
var L = (l, e, H) => e in l ? r(l, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : l[e] = H, n = (l, e) => {
  for (var H in e || (e = {}))
    A.call(e, H) && L(l, H, e[H]);
  if (t)
    for (var H of t(e))
      c.call(e, H) && L(l, H, e[H]);
  return l;
}, h = (l, e) => m(l, M(e));
...
]), Z = v((l, e) => /* @__PURE__ */ a.createElement(V, h(n({ ref: e }, l), { weights: o })));
Z.displayName = "Lighthouse";
const g = Z;
export {
  g as default
};
