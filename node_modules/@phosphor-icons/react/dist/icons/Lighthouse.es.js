...
var L = (l, e, H) => e in l ? Z(l, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : l[e] = H, n = (l, e) => {
  for (var H in e || (e = {}))
    M.call(e, H) && L(l, H, e[H]);
  if (t)
    for (var H of t(e))
...
]), o = c((l, e) => /* @__PURE__ */ a.createElement(v, r(n({ ref: e }, l), { weights: V })));
o.displayName = "Lighthouse";
export {
  o as default
};
