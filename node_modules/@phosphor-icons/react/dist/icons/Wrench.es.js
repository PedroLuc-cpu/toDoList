...
var c = (l, e, t) => e in l ? A(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, L = (l, e) => {
  for (var t in e || (e = {}))
    E.call(e, t) && c(l, t, e[t]);
  if (n)
    for (var t of n(e))
      p.call(e, t) && c(l, t, e[t]);
  return l;
}, r = (l, e) => h(l, o(e));
...
]), m = M((l, e) => /* @__PURE__ */ a.createElement(d, r(L({ ref: e }, l), { weights: Z })));
m.displayName = "Wrench";
const s = m;
export {
  s as default
};
