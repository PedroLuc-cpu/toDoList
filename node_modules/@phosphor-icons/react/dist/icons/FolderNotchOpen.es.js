...
var n = (l, e, H) => e in l ? A(l, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : l[e] = H, r = (l, e) => {
  for (var H in e || (e = {}))
    V.call(e, H) && n(l, H, e[H]);
  if (t)
    for (var H of t(e))
      o.call(e, H) && n(l, H, e[H]);
  return l;
}, m = (l, e) => h(l, c(e));
...
]), M = Z((l, e) => /* @__PURE__ */ a.createElement(p, m(r({ ref: e }, l), { weights: L })));
M.displayName = "FolderNotchOpen";
export {
  M as default
};
