...
var m = (t, e, V) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, n = (t, e) => {
  for (var V in e || (e = {}))
    H.call(e, V) && m(t, V, e[V]);
  if (l)
    for (var V of l(e))
      i.call(e, V) && m(t, V, e[V]);
  return t;
}, r = (t, e) => v(t, c(e));
...
]), h = A((t, e) => /* @__PURE__ */ a.createElement(E, r(n({ ref: e }, t), { weights: o })));
h.displayName = "FireExtinguisher";
const g = h;
export {
  g as default
};
