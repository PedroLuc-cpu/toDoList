...
var m = (A, e, t) => e in A ? M(A, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : A[e] = t, l = (A, e) => {
  for (var t in e || (e = {}))
    E.call(e, t) && m(A, t, e[t]);
  if (Z)
    for (var t of Z(e))
      p.call(e, t) && m(A, t, e[t]);
  return A;
}, n = (A, e) => c(A, o(e));
...
]), r = d((A, e) => /* @__PURE__ */ a.createElement(i, n(l({ ref: e }, A), { weights: h })));
r.displayName = "PawPrint";
const f = r;
export {
  f as default
};
