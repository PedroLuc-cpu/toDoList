...
var h = (V, H, e) => H in V ? l(V, H, { enumerable: !0, configurable: !0, writable: !0, value: e }) : V[H] = e, m = (V, H) => {
  for (var e in H || (H = {}))
    Z.call(H, e) && h(V, e, H[e]);
  if (t)
    for (var e of t(H))
...
]), A = p((V, H) => /* @__PURE__ */ a.createElement(o, v(m({ ref: H }, V), { weights: E })));
A.displayName = "Cpu";
export {
  A as default
};
