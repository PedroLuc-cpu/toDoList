...
var h = (V, H, e) => H in V ? n(V, H, { enumerable: !0, configurable: !0, writable: !0, value: e }) : V[H] = e, m = (V, H) => {
  for (var e in H || (H = {}))
    c.call(H, e) && h(V, e, H[e]);
  if (t)
    for (var e of t(H))
      p.call(H, e) && h(V, e, H[e]);
  return V;
}, v = (V, H) => r(V, Z(H));
...
]), l = o((V, H) => /* @__PURE__ */ a.createElement(E, v(m({ ref: H }, V), { weights: A })));
l.displayName = "Cpu";
const s = l;
export {
  s as default
