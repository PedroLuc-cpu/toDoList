...
var r = (t, a, m) => a in t ? n(t, a, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[a] = m, l = (t, a) => {
  for (var m in a || (a = {}))
    A.call(a, m) && r(t, m, a[m]);
  if (H)
    for (var m of H(a))
...
]), d = M((t, a) => /* @__PURE__ */ e.createElement(c, V(l({ ref: a }, t), { weights: o })));
d.displayName = "GridFour";
export {
  d as default
};
