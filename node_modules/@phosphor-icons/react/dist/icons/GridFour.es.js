...
var H = (t, a, m) => a in t ? h(t, a, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[a] = m, l = (t, a) => {
  for (var m in a || (a = {}))
    v.call(a, m) && H(t, m, a[m]);
  if (r)
    for (var m of r(a))
      c.call(a, m) && H(t, m, a[m]);
  return t;
}, n = (t, a) => Z(t, A(a));
...
]), V = M((t, a) => /* @__PURE__ */ e.createElement(o, n(l({ ref: a }, t), { weights: d })));
V.displayName = "GridFour";
const i = V;
export {
  i as default
};
