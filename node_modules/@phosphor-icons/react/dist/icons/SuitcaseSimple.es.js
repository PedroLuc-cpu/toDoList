...
var V = (t, a, H) => a in t ? r(t, a, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[a] = H, n = (t, a) => {
  for (var H in a || (a = {}))
    A.call(a, H) && V(t, H, a[H]);
  if (l)
    for (var H of l(a))
      c.call(a, H) && V(t, H, a[H]);
  return t;
}, m = (t, a) => Z(t, M(a));
...
]), o = v((t, a) => /* @__PURE__ */ e.createElement(h, m(n({ ref: a }, t), { weights: p })));
o.displayName = "SuitcaseSimple";
export {
  o as default
};
