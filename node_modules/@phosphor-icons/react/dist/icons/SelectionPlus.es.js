...
var Z = (t, e, H) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, m = (t, e) => {
  for (var H in e || (e = {}))
    v.call(e, H) && Z(t, H, e[H]);
  if (V)
    for (var H of V(e))
      A.call(e, H) && Z(t, H, e[H]);
  return t;
}, l = (t, e) => M(t, r(e));
...
]), h = c((t, e) => /* @__PURE__ */ a.createElement(o, l(m({ ref: e }, t), { weights: E })));
h.displayName = "SelectionPlus";
const i = h;
export {
  i as default
};
