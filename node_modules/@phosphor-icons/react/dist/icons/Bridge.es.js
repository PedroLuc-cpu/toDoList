...
var l = (t, e, V) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, H = (t, e) => {
  for (var V in e || (e = {}))
    h.call(e, V) && l(t, V, e[V]);
  if (m)
    for (var V of m(e))
...
]), p = M((t, e) => /* @__PURE__ */ a.createElement(d, n(H({ ref: e }, t), { weights: o })));
p.displayName = "Bridge";
export {
  p as default
};
