...
var l = (c, a, t) => a in c ? A(c, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : c[a] = t, n = (c, a) => {
  for (var t in a || (a = {}))
    Z.call(a, t) && l(c, t, a[t]);
  if (C)
    for (var t of C(a))
      M.call(a, t) && l(c, t, a[t]);
  return c;
}, r = (c, a) => m(c, V(a));
