...
var a = (t, e, Z) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : t[e] = Z, l = (t, e) => {
  for (var Z in e || (e = {}))
    V.call(e, Z) && a(t, Z, e[Z]);
  if (m)
    for (var Z of m(e))
      h.call(e, Z) && a(t, Z, e[Z]);
  return t;
}, r = (t, e) => M(t, H(e));
...
]), E = c((t, e) => /* @__PURE__ */ A.createElement(o, r(l({ ref: e }, t), { weights: p })));
E.displayName = "ChartPolar";
export {
  E as default
};
