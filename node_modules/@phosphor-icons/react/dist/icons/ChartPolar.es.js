...
var m = (t, e, Z) => e in t ? M(t, e, { enumerable: !0, configurable: !0, writable: !0, value: Z }) : t[e] = Z, l = (t, e) => {
  for (var Z in e || (e = {}))
    V.call(e, Z) && m(t, Z, e[Z]);
  if (a)
    for (var Z of a(e))
...
]), n = o((t, e) => /* @__PURE__ */ A.createElement(E, r(l({ ref: e }, t), { weights: p })));
n.displayName = "ChartPolar";
const u = n;
export {
  u as default
};
