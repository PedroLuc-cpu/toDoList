...
var L = (t, e, l) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, H = (t, e) => {
  for (var l in e || (e = {}))
    Z.call(e, l) && L(t, l, e[l]);
  if (m)
    for (var l of m(e))
...
]), p = c((t, e) => /* @__PURE__ */ a.createElement(o, V(H({ ref: e }, t), { weights: M })));
p.displayName = "ArrowsIn";
export {
  p as default
};
