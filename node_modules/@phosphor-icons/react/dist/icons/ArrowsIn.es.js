...
var L = (t, e, l) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, H = (t, e) => {
  for (var l in e || (e = {}))
    c.call(e, l) && L(t, l, e[l]);
  if (m)
    for (var l of m(e))
      h.call(e, l) && L(t, l, e[l]);
  return t;
}, n = (t, e) => A(t, Z(e));
...
]), V = o((t, e) => /* @__PURE__ */ a.createElement(M, n(H({ ref: e }, t), { weights: E })));
V.displayName = "ArrowsIn";
const g = V;
export {
  g as default
};
