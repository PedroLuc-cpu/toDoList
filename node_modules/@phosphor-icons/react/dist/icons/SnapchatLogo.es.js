...
var n = (e, c, l) => c in e ? s(e, c, { enumerable: !0, configurable: !0, writable: !0, value: l }) : e[c] = l, m = (e, c) => {
  for (var l in c || (c = {}))
    o.call(c, l) && n(e, l, c[l]);
  if (t)
    for (var l of t(c))
      p.call(c, l) && n(e, l, c[l]);
  return e;
}, r = (e, c) => A(e, h(c));
...
]), g = E((e, c) => /* @__PURE__ */ a.createElement(d, r(m({ ref: c }, e), { weights: Z })));
g.displayName = "SnapchatLogo";
export {
  g as default
};
