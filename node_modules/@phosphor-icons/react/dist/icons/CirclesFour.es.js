...
var Z = (m, e, t) => e in m ? n(m, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : m[e] = t, l = (m, e) => {
  for (var t in e || (e = {}))
    M.call(e, t) && Z(m, t, e[t]);
  if (A)
    for (var t of A(e))
...
]), u = E((m, e) => /* @__PURE__ */ a.createElement(d, r(l({ ref: e }, m), { weights: i })));
u.displayName = "CirclesFour";
export {
  u as default
};
