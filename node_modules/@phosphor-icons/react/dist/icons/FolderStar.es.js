...
var n = (e, l, t) => l in e ? L(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, H = (e, l) => {
  for (var t in l || (l = {}))
    M.call(l, t) && n(e, t, l[t]);
  if (r)
    for (var t of r(l))
      c.call(l, t) && n(e, t, l[t]);
  return e;
}, m = (e, l) => Z(e, V(l));
...
]), A = h((e, l) => /* @__PURE__ */ a.createElement(o, m(H({ ref: l }, e), { weights: d })));
A.displayName = "FolderStar";
const u = A;
export {
  u as default
};
