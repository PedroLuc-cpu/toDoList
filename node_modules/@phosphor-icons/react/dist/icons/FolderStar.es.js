...
var n = (e, l, t) => l in e ? A(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, H = (e, l) => {
  for (var t in l || (l = {}))
    V.call(l, t) && n(e, t, l[t]);
  if (r)
    for (var t of r(l))
...
]), d = c((e, l) => /* @__PURE__ */ a.createElement(h, m(H({ ref: l }, e), { weights: o })));
d.displayName = "FolderStar";
export {
  d as default
};
