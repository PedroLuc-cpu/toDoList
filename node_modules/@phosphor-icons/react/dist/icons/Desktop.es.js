...
var n = (t, a, H) => a in t ? h(t, a, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[a] = H, r = (t, a) => {
  for (var H in a || (a = {}))
...
]), p = M((t, a) => /* @__PURE__ */ e.createElement(Z, V(r({ ref: a }, t), { weights: o })));
p.displayName = "Desktop";
export {
  p as default
};
