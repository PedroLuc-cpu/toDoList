...
var m = (t, a, H) => a in t ? h(t, a, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[a] = H, n = (t, a) => {
  for (var H in a || (a = {}))
    v.call(a, H) && m(t, H, a[H]);
  if (l)
    for (var H of l(a))
...
]), p = M((t, a) => /* @__PURE__ */ e.createElement(A, r(n({ ref: a }, t), { weights: o })));
p.displayName = "CurrencyNgn";
export {
  p as default
};
