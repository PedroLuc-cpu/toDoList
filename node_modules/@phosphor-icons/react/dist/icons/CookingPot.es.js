...
var l = (t, e, V) => e in t ? H(t, e, { enumerable: !0, configurable: !0, writable: !0, value: V }) : t[e] = V, n = (t, e) => {
  for (var V in e || (e = {}))
    c.call(e, V) && l(t, V, e[V]);
  if (m)
    for (var V of m(e))
      v.call(e, V) && l(t, V, e[V]);
  return t;
}, Z = (t, e) => o(t, A(e));
...
]), r = L((t, e) => /* @__PURE__ */ a.createElement(E, Z(n({ ref: e }, t), { weights: p })));
r.displayName = "CookingPot";
const i = r;
export {
  i as default
};
