...
var A = (l, e, t) => e in l ? L(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, m = (l, e) => {
  for (var t in e || (e = {}))
    M.call(e, t) && A(l, t, e[t]);
  if (H)
    for (var t of H(e))
      c.call(e, t) && A(l, t, e[t]);
  return l;
}, n = (l, e) => Z(l, V(e));
...
]), r = h((l, e) => /* @__PURE__ */ a.createElement(o, n(m({ ref: e }, l), { weights: E })));
r.displayName = "CameraSlash";
const g = r;
export {
  g as default
};
