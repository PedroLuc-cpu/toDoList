...
var l = (a, t, m) => t in a ? Z(a, t, { enumerable: !0, configurable: !0, writable: !0, value: m }) : a[t] = m, r = (a, t) => {
  for (var m in t || (t = {}))
    d.call(t, m) && l(a, m, t[m]);
  if (n)
    for (var m of n(t))
...
]), h = E((a, t) => /* @__PURE__ */ e.createElement(i, A(r({ ref: t }, a), { weights: u })));
