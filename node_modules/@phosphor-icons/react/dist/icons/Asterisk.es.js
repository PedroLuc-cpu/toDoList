...
var r = (t, a, l) => a in t ? c(t, a, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[a] = l, L = (t, a) => {
  for (var l in a || (a = {}))
...
]), h = d((t, a) => /* @__PURE__ */ e.createElement(i, m(L({ ref: a }, t), { weights: A })));
h.displayName = "Asterisk";
export {
  h as default
};
