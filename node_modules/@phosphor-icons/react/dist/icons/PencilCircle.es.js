...
var Z = (l, e, t) => e in l ? A(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, n = (l, e) => {
  for (var t in e || (e = {}))
    h.call(e, t) && Z(l, t, e[t]);
  if (m)
    for (var t of m(e))
      i.call(e, t) && Z(l, t, e[t]);
  return l;
}, c = (l, e) => v(l, M(e));
...
]), r = o((l, e) => /* @__PURE__ */ a.createElement(E, c(n({ ref: e }, l), { weights: p })));
r.displayName = "PencilCircle";
const L = r;
export {
  L as default
};
