...
var l = (t, a, c) => a in t ? C(t, a, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[a] = c, n = (t, a) => {
  for (var c in a || (a = {}))
    E.call(a, c) && l(t, c, a[c]);
  if (m)
    for (var c of m(a))
      o.call(a, c) && l(t, c, a[c]);
  return t;
}, r = (t, a) => Z(t, s(a));
...
]), A = M((t, a) => /* @__PURE__ */ e.createElement(p, r(n({ ref: a }, t), { weights: d })));
A.displayName = "Eye";
const i = A;
export {
  i as default
