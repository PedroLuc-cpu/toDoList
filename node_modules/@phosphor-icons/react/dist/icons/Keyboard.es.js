...
var m = (A, e, h) => e in A ? n(A, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : A[e] = h, Z = (A, e) => {
  for (var h in e || (e = {}))
    c.call(e, h) && m(A, h, e[h]);
  if (t)
    for (var h of t(e))
      v.call(e, h) && m(A, h, e[h]);
  return A;
}, H = (A, e) => r(A, M(e));
...
]), l = o((A, e) => /* @__PURE__ */ a.createElement(d, H(Z({ ref: e }, A), { weights: E })));
l.displayName = "Keyboard";
const i = l;
export {
  i as default
};
