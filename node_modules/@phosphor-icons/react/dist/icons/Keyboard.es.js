...
var m = (A, e, h) => e in A ? l(A, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : A[e] = h, Z = (A, e) => {
  for (var h in e || (e = {}))
    M.call(e, h) && m(A, h, e[h]);
  if (t)
    for (var h of t(e))
...
]), p = v((A, e) => /* @__PURE__ */ a.createElement(o, H(Z({ ref: e }, A), { weights: d })));
p.displayName = "Keyboard";
export {
  p as default
};
