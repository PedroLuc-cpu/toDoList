...
var n = (t, a, m) => a in t ? o(t, a, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[a] = m, A = (t, a) => {
  for (var m in a || (a = {}))
    E.call(a, m) && n(t, m, a[m]);
  if (l)
    for (var m of l(a))
      d.call(a, m) && n(t, m, a[m]);
  return t;
}, r = (t, a) => c(t, p(a));
...
]), Z = g((t, a) => /* @__PURE__ */ e.createElement(i, r(A({ ref: a }, t), { weights: h })));
Z.displayName = "SpotifyLogo";
const s = Z;
export {
  s as default
};
