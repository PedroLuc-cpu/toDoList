...
var r = (t, a, H) => a in t ? c(t, a, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[a] = H, l = (t, a) => {
  for (var H in a || (a = {}))
    Z.call(a, H) && r(t, H, a[H]);
  if (n)
    for (var H of n(a))
...
]), p = M((t, a) => /* @__PURE__ */ e.createElement(h, m(l({ ref: a }, t), { weights: o })));
p.displayName = "PictureInPicture";
export {
  p as default
};
