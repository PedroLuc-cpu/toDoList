...
var m = (t, e, c) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[e] = c, C = (t, e) => {
  for (var c in e || (e = {}))
    M.call(e, c) && m(t, c, e[c]);
  if (Z)
    for (var c of Z(e))
      s.call(e, c) && m(t, c, e[c]);
  return t;
}, n = (t, e) => l(t, r(e));
...
]), o = A((t, e) => /* @__PURE__ */ a.createElement(H, n(C({ ref: e }, t), { weights: v })));
o.displayName = "Footprints";
export {
  o as default
};
