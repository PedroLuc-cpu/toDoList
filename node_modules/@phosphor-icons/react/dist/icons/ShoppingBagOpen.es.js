...
var V = (t, a, m) => a in t ? r(t, a, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[a] = m, l = (t, a) => {
  for (var m in a || (a = {}))
    c.call(a, m) && V(t, m, a[m]);
  if (n)
    for (var m of n(a))
      A.call(a, m) && V(t, m, a[m]);
  return t;
}, H = (t, a) => Z(t, p(a));
...
]), g = o((t, a) => /* @__PURE__ */ e.createElement(M, H(l({ ref: a }, t), { weights: E })));
g.displayName = "ShoppingBagOpen";
export {
  g as default
};
