...
var L = (e, a, t) => a in e ? c(e, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[a] = t, A = (e, a) => {
  for (var t in a || (a = {}))
    o.call(a, t) && L(e, t, a[t]);
  if (n)
    for (var t of n(a))
      E.call(a, t) && L(e, t, a[t]);
  return e;
}, r = (e, a) => p(e, i(a));
...
]), m = d((e, a) => /* @__PURE__ */ l.createElement(H, r(A({ ref: a }, e), { weights: Z })));
m.displayName = "AirplaneTilt";
const s = m;
export {
  s as default
};
