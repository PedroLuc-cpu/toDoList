...
var n = (e, a, t) => a in e ? m(e, a, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[a] = t, A = (e, a) => {
  for (var t in a || (a = {}))
    o.call(a, t) && n(e, t, a[t]);
  if (L)
    for (var t of L(a))
      E.call(a, t) && n(e, t, a[t]);
  return e;
}, r = (e, a) => c(e, p(a));
...
]), Z = i((e, a) => /* @__PURE__ */ l.createElement(d, r(A({ ref: a }, e), { weights: H })));
Z.displayName = "AirplaneTilt";
export {
  Z as default
};
