...
var A = (t, e, h) => e in t ? c(t, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : t[e] = h, l = (t, e) => {
  for (var h in e || (e = {}))
    Z.call(e, h) && A(t, h, e[h]);
  if (m)
    for (var h of m(e))
      V.call(e, h) && A(t, h, e[h]);
  return t;
}, H = (t, e) => n(t, r(e));
...
]), E = o((t, e) => /* @__PURE__ */ a.createElement(M, H(l({ ref: e }, t), { weights: p })));
E.displayName = "Scroll";
export {
  E as default
};
