...
var m = (t, e, H) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, h = (t, e) => {
  for (var H in e || (e = {}))
    L.call(e, H) && m(t, H, e[H]);
  if (l)
    for (var H of l(e))
      Z.call(e, H) && m(t, H, e[H]);
  return t;
}, n = (t, e) => V(t, c(e));
...
]), r = o((t, e) => /* @__PURE__ */ a.createElement(E, n(h({ ref: e }, t), { weights: p })));
r.displayName = "CameraPlus";
const s = r;
export {
  s as default
};
