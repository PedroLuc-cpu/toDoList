...
var n = (e, l, H) => l in e ? L(e, l, { enumerable: !0, configurable: !0, writable: !0, value: H }) : e[l] = H, m = (e, l) => {
  for (var H in l || (l = {}))
    E.call(l, H) && n(e, H, l[H]);
  if (t)
    for (var H of t(l))
      Z.call(l, H) && n(e, H, l[H]);
  return e;
}, r = (e, l) => c(e, o(l));
...
]), h = p((e, l) => /* @__PURE__ */ a.createElement(d, r(m({ ref: l }, e), { weights: A })));
h.displayName = "Hash";
const M = h;
export {
  M as default
