...
var A = (l, e, t) => e in l ? m(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, n = (l, e) => {
  for (var t in e || (e = {}))
    L.call(e, t) && A(l, t, e[t]);
  if (c)
    for (var t of c(e))
...
]), C = o((l, e) => /* @__PURE__ */ a.createElement(E, r(n({ ref: e }, l), { weights: M })));
C.displayName = "Pepper";
export {
  C as default
};
