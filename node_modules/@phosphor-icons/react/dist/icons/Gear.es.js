...
var A = (L, l, e) => l in L ? r(L, l, { enumerable: !0, configurable: !0, writable: !0, value: e }) : L[l] = e, m = (L, l) => {
  for (var e in l || (l = {}))
    Z.call(l, e) && A(L, e, l[e]);
  if (t)
    for (var e of t(l))
      h.call(l, e) && A(L, e, l[e]);
  return L;
}, n = (L, l) => c(L, q(l));
...
]), d = o((L, l) => /* @__PURE__ */ a.createElement(p, n(m({ ref: l }, L), { weights: E })));
d.displayName = "Gear";
export {
  d as default
};
