...
var L = (e, l, A) => l in e ? r(e, l, { enumerable: !0, configurable: !0, writable: !0, value: A }) : e[l] = A, n = (e, l) => {
  for (var A in l || (l = {}))
    V.call(l, A) && L(e, A, l[A]);
  if (t)
    for (var A of t(l))
      c.call(l, A) && L(e, A, l[A]);
  return e;
}, m = (e, l) => Z(e, H(l));
...
]), p = h((e, l) => /* @__PURE__ */ a.createElement(M, m(n({ ref: l }, e), { weights: o })));
p.displayName = "GearFine";
export {
  p as default
};
