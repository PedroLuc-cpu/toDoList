...
var n = (t, e, m) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, H = (t, e) => {
  for (var m in e || (e = {}))
    c.call(e, m) && n(t, m, e[m]);
  if (l)
    for (var m of l(e))
      v.call(e, m) && n(t, m, e[m]);
  return t;
}, V = (t, e) => A(t, h(e));
...
const p = /* @__PURE__ */ new Map([
  ...
  [
    ...
    ), /* @__PURE__ */ a.createElement("path", { d: "M216,136H80a16,16,0,0,0-16,16v40a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V152A16,16,0,0,0,216,136Zm0,56H80V152H216v40ZM48,40V216a8,8,0,0,1-16,0V40a8,8,0,0,1,16,0Zm32,80h96a16,16,0,0,0,16-16V64a16,16,0,0,0-16-16H80A16,16,0,0,0,64,64v40A16,16,0,0,0,80,120Zm0-56h96v40H80Z" }))
  ],
  [
    "fill",
...
]), Z = o((t, e) => /* @__PURE__ */ a.createElement(E, V(H({ ref: e }, t), { weights: p })));
Z.displayName = "AlignLeft";
const M = Z;
export {
  M as default
};
