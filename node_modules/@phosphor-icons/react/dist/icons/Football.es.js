...
var c = (e, l, t) => l in e ? r(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, m = (e, l) => {
  for (var t in l || (l = {}))
    M.call(l, t) && c(e, t, l[t]);
  if (L)
    for (var t of L(l))
      o.call(l, t) && c(e, t, l[t]);
  return e;
}, n = (e, l) => Z(e, A(l));
...
]), E = C((e, l) => /* @__PURE__ */ a.createElement(p, n(m({ ref: l }, e), { weights: s })));
E.displayName = "Football";
export {
  E as default
};
