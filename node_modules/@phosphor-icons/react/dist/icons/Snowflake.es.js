...
var n = (e, a, L) => a in e ? m(e, a, { enumerable: !0, configurable: !0, writable: !0, value: L }) : e[a] = L, r = (e, a) => {
  for (var L in a || (a = {}))
    p.call(a, L) && n(e, L, a[L]);
  if (t)
    for (var L of t(a))
      E.call(a, L) && n(e, L, a[L]);
  return e;
}, A = (e, a) => c(e, o(a));
...
]), h = V((e, a) => /* @__PURE__ */ l.createElement(d, A(r({ ref: a }, e), { weights: v })));
h.displayName = "Snowflake";
export {
  h as default
};
