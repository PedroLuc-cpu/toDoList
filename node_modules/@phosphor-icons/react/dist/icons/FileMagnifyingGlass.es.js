...
var m = (t, e, l) => e in t ? M(t, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : t[e] = l, V = (t, e) => {
  for (var l in e || (e = {}))
    H.call(e, l) && m(t, l, e[l]);
  if (n)
    for (var l of n(e))
      c.call(e, l) && m(t, l, e[l]);
  return t;
}, Z = (t, e) => A(t, h(e));
...
]), r = i((t, e) => /* @__PURE__ */ a.createElement(g, Z(V({ ref: e }, t), { weights: o })));
