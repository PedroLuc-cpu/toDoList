...
var Z = (t, e, H) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: H }) : t[e] = H, V = (t, e) => {
  for (var H in e || (e = {}))
    M.call(e, H) && Z(t, H, e[H]);
  if (m)
    for (var H of m(e))
      c.call(e, H) && Z(t, H, e[H]);
  return t;
}, A = (t, e) => h(t, r(e));
...
]), l = o((t, e) => /* @__PURE__ */ a.createElement(E, A(V({ ref: e }, t), { weights: p })));
l.displayName = "Robot";
const u = l;
export {
  u as default
