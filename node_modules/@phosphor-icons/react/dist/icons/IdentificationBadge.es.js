...
var m = (t, e, n) => e in t ? r(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, l = (t, e) => {
  for (var n in e || (e = {}))
    V.call(e, n) && m(t, n, e[n]);
  if (A)
    for (var n of A(e))
      d.call(e, n) && m(t, n, e[n]);
  return t;
}, Z = (t, e) => c(t, M(e));
...
]), H = i((t, e) => /* @__PURE__ */ a.createElement(o, Z(l({ ref: e }, t), { weights: h })));
H.displayName = "IdentificationBadge";
const f = H;
export {
  f as default
};
