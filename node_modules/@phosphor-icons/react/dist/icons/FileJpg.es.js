...
var V = (t, e, h) => e in t ? A(t, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : t[e] = h, m = (t, e) => {
  for (var h in e || (e = {}))
...
]), p = M((t, e) => /* @__PURE__ */ a.createElement(s, Z(m({ ref: e }, t), { weights: H })));
p.displayName = "FileJpg";
export {
  p as default
};
