...
var V = (t, e, h) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: h }) : t[e] = h, m = (t, e) => {
  for (var h in e || (e = {}))
    r.call(e, h) && V(t, h, e[h]);
  if (l)
    for (var h of l(e))
      M.call(e, h) && V(t, h, e[h]);
  return t;
}, Z = (t, e) => c(t, v(e));
...
]), A = s((t, e) => /* @__PURE__ */ a.createElement(H, Z(m({ ref: e }, t), { weights: p })));
A.displayName = "FileJpg";
const g = A;
export {
  g as default
};
