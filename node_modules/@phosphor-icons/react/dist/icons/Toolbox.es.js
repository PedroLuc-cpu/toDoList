...
var V = (H, e, v) => e in H ? h(H, e, { enumerable: !0, configurable: !0, writable: !0, value: v }) : H[e] = v, l = (H, e) => {
  for (var v in e || (e = {}))
    Z.call(e, v) && V(H, v, e[v]);
  if (t)
    for (var v of t(e))
      o.call(e, v) && V(H, v, e[v]);
  return H;
}, n = (H, e) => m(H, A(e));
...
]), r = M((H, e) => /* @__PURE__ */ a.createElement(c, n(l({ ref: e }, H), { weights: E })));
r.displayName = "Toolbox";
const u = r;
export {
  u as default
};
