...
var V = (H, e, v) => e in H ? r(H, e, { enumerable: !0, configurable: !0, writable: !0, value: v }) : H[e] = v, l = (H, e) => {
  for (var v in e || (e = {}))
    A.call(e, v) && V(H, v, e[v]);
  if (t)
    for (var v of t(e))
...
]), p = M((H, e) => /* @__PURE__ */ a.createElement(o, n(l({ ref: e }, H), { weights: c })));
p.displayName = "Toolbox";
export {
  p as default
};
