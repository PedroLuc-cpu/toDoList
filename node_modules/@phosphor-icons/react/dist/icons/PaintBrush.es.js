...
var m = (t, a, c) => a in t ? Z(t, a, { enumerable: !0, configurable: !0, writable: !0, value: c }) : t[a] = c, l = (t, a) => {
  for (var c in a || (a = {}))
    h.call(a, c) && m(t, c, a[c]);
  if (n)
    for (var c of n(a))
      o.call(a, c) && m(t, c, a[c]);
  return t;
}, r = (t, a) => C(t, M(a));
...
]), A = E((t, a) => /* @__PURE__ */ e.createElement(p, r(l({ ref: a }, t), { weights: d })));
A.displayName = "PaintBrush";
const H = A;
export {
  H as default
};
