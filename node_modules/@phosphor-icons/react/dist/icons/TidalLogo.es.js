...
var m = (e, l, t) => l in e ? c(e, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[l] = t, n = (e, l) => {
  for (var t in l || (l = {}))
    M.call(l, t) && m(e, t, l[t]);
  if (L)
    for (var t of L(l))
      E.call(l, t) && m(e, t, l[t]);
  return e;
}, Z = (e, l) => o(e, d(l));
...
]), r = p((e, l) => /* @__PURE__ */ a.createElement(g, Z(n({ ref: l }, e), { weights: i })));
r.displayName = "TidalLogo";
const f = r;
export {
  f as default
};
