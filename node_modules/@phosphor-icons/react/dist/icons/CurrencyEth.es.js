...
var n = (a, l, t) => l in a ? c(a, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[l] = t, r = (a, l) => {
  for (var t in l || (l = {}))
    o.call(l, t) && n(a, t, l[t]);
  if (m)
    for (var t of m(l))
...
]), g = d((a, l) => /* @__PURE__ */ e.createElement(h, Z(r({ ref: l }, a), { weights: u })));
g.displayName = "CurrencyEth";
export {
  g as default
};
