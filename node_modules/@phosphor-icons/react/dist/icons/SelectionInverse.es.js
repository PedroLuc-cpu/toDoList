...
var m = (t, e, n) => e in t ? Z(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, H = (t, e) => {
  for (var n in e || (e = {}))
    h.call(e, n) && m(t, n, e[n]);
  if (l)
    for (var n of l(e))
      M.call(e, n) && m(t, n, e[n]);
  return t;
}, r = (t, e) => A(t, c(e));
...
]), V = o((t, e) => /* @__PURE__ */ a.createElement(v, r(H({ ref: e }, t), { weights: E })));
V.displayName = "SelectionInverse";
const i = V;
export {
  i as default
};
