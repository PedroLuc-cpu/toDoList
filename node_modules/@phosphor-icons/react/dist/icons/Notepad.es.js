...
var h = (V, e, t) => e in V ? r(V, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : V[e] = t, m = (V, e) => {
  for (var t in e || (e = {}))
    c.call(e, t) && h(V, t, e[t]);
  if (H)
    for (var t of H(e))
      A.call(e, t) && h(V, t, e[t]);
  return V;
}, l = (V, e) => Z(V, v(e));
...
]), n = o((V, e) => /* @__PURE__ */ a.createElement(p, l(m({ ref: e }, V), { weights: d })));
n.displayName = "Notepad";
const u = n;
export {
  u as default
};
