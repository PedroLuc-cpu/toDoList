...
var Z = (l, e, t) => e in l ? r(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t, L = (l, e) => {
  for (var t in e || (e = {}))
    A.call(e, t) && Z(l, t, e[t]);
  if (m)
    for (var t of m(e))
      d.call(e, t) && Z(l, t, e[t]);
  return l;
}, n = (l, e) => M(l, c(e));
...
]), p = E((l, e) => /* @__PURE__ */ a.createElement(h, n(L({ ref: e }, l), { weights: o })));
p.displayName = "Bandaids";
export {
  p as default
};
