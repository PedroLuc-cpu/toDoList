...
var Z = (c, t, m) => t in c ? n(c, t, { enumerable: !0, configurable: !0, writable: !0, value: m }) : c[t] = m, l = (c, t) => {
  for (var m in t || (t = {}))
    M.call(t, m) && Z(c, m, t[m]);
  if (a)
    for (var m of a(t))
...
]), d = p((c, t) => /* @__PURE__ */ e.createElement(E, A(l({ ref: t }, c), { weights: H })));
d.displayName = "GlobeSimple";
export {
  d as default
};
