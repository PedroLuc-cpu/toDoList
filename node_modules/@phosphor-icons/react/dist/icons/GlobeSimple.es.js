...
var Z = (c, t, m) => t in c ? r(c, t, { enumerable: !0, configurable: !0, writable: !0, value: m }) : c[t] = m, l = (c, t) => {
  for (var m in t || (t = {}))
    o.call(t, m) && Z(c, m, t[m]);
  if (a)
    for (var m of a(t))
      p.call(t, m) && Z(c, m, t[m]);
  return c;
}, n = (c, t) => h(c, M(t));
...
]), A = E((c, t) => /* @__PURE__ */ e.createElement(H, n(l({ ref: t }, c), { weights: d })));
A.displayName = "GlobeSimple";
const C = A;
export {
  C as default
};
