...
var n = (t, e, m) => e in t ? h(t, e, { enumerable: !0, configurable: !0, writable: !0, value: m }) : t[e] = m, Z = (t, e) => {
  for (var m in e || (e = {}))
    u.call(e, m) && n(t, m, e[m]);
  if (l)
    for (var m of l(e))
...
]), H = E((t, e) => /* @__PURE__ */ a.createElement(p, r(Z({ ref: e }, t), { weights: d })));
H.displayName = "Queue";
const s = H;
export {
  s as default
