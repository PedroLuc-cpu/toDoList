...
var l = (e, V, t) => V in e ? r(e, V, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[V] = t, A = (e, V) => {
  for (var t in V || (V = {}))
    c.call(V, t) && l(e, t, V[t]);
  if (H)
    for (var t of H(V))
...
]), p = Z((e, V) => /* @__PURE__ */ a.createElement(L, h(A({ ref: V }, e), { weights: o })));
p.displayName = "CastleTurret";
export {
  p as default
};
